...
MySQL - 10.3.39-MariaDB-log : Database - eduarcom_bdcenterm
*********************************************************************
*/
...
BEGIN
SELECT nomb,idalma,dire,ciud,sucuidserie,ubigeo FROM fe_sucu where idalma in(1,4,6)  order by idalma;
END */$$
DELIMITER ;
