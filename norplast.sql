...
MySQL - 8.0.41 : Database - syscom_bdnorplast
*********************************************************************
*/
...
lcaj_tran,lcaj_fope,lcaj_form)values
(dfecha,cndoc,cdeta,idcta,sdeudor,sacreedor,cmone,ndolar,nidus,nidcp,'T',localtime,'E');
select last_insert_id() into id from fe_lcaja group by last_insert_id();
return id;
end */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProIngresaDetalleOCompra`(nid integer,nidart integer,ncant decimal(12,2),nprec decimal(13,5),cestado char)
BEGIN
insert into fe_docom(doco_idro,doco_coda,doco_cant,doco_prec,doco_tipo)
values(nid,nidart,ncant,nprec,cestado);
END */$$
DELIMITER ;
...
nct float,cincl char,tmvto char,ccodv integer,calma integer,nidcosto1 decimal(12,4),vcom float,ctdoc varchar(2))
BEGIN
INSERT INTO fe_kar(idauto,idart,tipo,prec,cant,ttip,incl,alma,kar_cost,codv,kar_comi)
VALUES (nid,cc,ct,npr,nct,tmvto,cincl,calma,nidcosto1,ccodv,vcom);
case 
when calma=0 THEN
