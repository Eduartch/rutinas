...
MySQL - 8.0.45 : Database - eduar_bdbatnor
*********************************************************************
*/
...
/*!50003 CREATE FUNCTION `FunIngresaDCreditos`(dfecha datetime,dfevto datetime,nimpo float,cndoc varchar(15),
...
cidpc VARCHAR(45),nidus INTEGER,cdespacho VARCHAR(100),cforma VARCHAR(100),nv FLOAT,nigv FLOAT,nimpo FLOAT) RETURNS int
BEGIN
DECLARE nid INTEGER;
...
caten,cdeta,cidpc,nidus,LOCALTIME,cdespacho,cforma,nv,nigv,nimpo);
...
ctipo CHAR,nimpo DECIMAL(12,2),nidalma INTEGER,deta varchar(100)) RETURNS int
BEGIN
DECLARE nid INTEGER DEFAULT 0;
...
/*!50003 CREATE PROCEDURE `ProActualizaOCompra`(nid VARCHAR(15),opt CHAR,nidart VARCHAR(15),ncant FLOAT,nprec FLOAT)
BEGIN
IF opt='E' THEN
...
/*!50003 CREATE PROCEDURE `ProActualizaProductos`(cdesc varchar(100),cunid varchar(4),ncosto float,np1 float,np2 float,
