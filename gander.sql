...
MySQL - 8.0.37 : Database - sysven_bdgander
*********************************************************************
*/
...
if opt=1 then
    ...
    prod_come,prod_comc,ulpc,prod_idus,prod_uact,prod_fact,fechc,prod_smax,prod_smin,ifnull(o.razo,'') as proveedor,
    ifnull(yy.ndoc,'') as ndoc,ifnull(yy.fech,'') as fech,ulfc,prod_ent1,prod_ent2,prod_icbper,g.desgrupo as grupo,b.desflete,
