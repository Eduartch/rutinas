...
MySQL - 8.0.42 : Database - sysven_bdkostaplast
*********************************************************************
*/
...
/*!50003 CREATE FUNCTION `FunHayTraspaso`(cdcto varchar(2),ctdoc varchar(2),nidauto integer) RETURNS int
BEGIN
declare sw integer default 0;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET sw=0;
...
fusua,idusua,codt,rcom_reci)VALUES (ctdoc,cform,cndoc,dfecha,dfecha,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,ni,ctg,cmvto,
...
ctdoc VARCHAR(2),cform CHAR,cndoc VARCHAR(12),dfecha DATE,dfechar DATE,cdetalle VARCHAR(120),
nv FLOAT,nigv FLOAT,nt FLOAT,cndo2 VARCHAR(10),cm CHAR,ndolar FLOAT,ni FLOAT,ctg CHAR,ccodp INTEGER,cmvto CHAR,nus INTEGER,opt INTEGER,nidcodt INTEGER,
n1 INTEGER,n2 INTEGER,n3 INTEGER,nitem INTEGER,npvta FLOAT) RETURNS int
BEGIN
DECLARE nid,idce INTEGER;
SET nid=0;
...
/*!50003 CREATE PROCEDURE `ProDesactivaDeudas`(nid integer)
BEGIN
...
igv=nigv,impo=nt,ndo2=cndo2,mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,tipom=cmvto,codt=nidcodt,rcom_reci='P' where idauto=nauto;
END */$$
DELIMITER ;
...
on a.idauto=b.idauto where b.acti='A' and a.acti='A' and tdoc not in('GI','20')  group by  idart) as a;
DECLARE CONTINUE HANDLER FOR SQLSTATE '02000' SET done = 1;
open cursor1;
start transaction;
