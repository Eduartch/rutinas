...
MySQL - 10.3.39-MariaDB : Database - eduarcom_bddoslperu
*********************************************************************
*/
...
crefe varchar(255),linea decimal(12,2),crpm varchar(10),nidz integer,ndias integer,cconta varchar(150),cdire1 varchar(150),nids integer) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
INSERT INTO eduarcom_bdverde2l.fe_clie(nruc,razo,dire,ciud,fono,fax,ndni,clie_tipo,clie_corr,clie_codv,clie_idus,idpcclie,
fechclie,celu,refe,clie_lcre,clie_rpm,clie_idzo,clie_dias,clie_conta,clie_dire1,clie_idse)
...
ncome float,ncomc float,nutil1 float,nutil2 float,nutil3 float,nidusua integer,nsmin float,nsmax float,ccodigo varchar(15),ndolar float,nutil0 DECIMAL(8,5)) RETURNS int(11)
BEGIN
declare nid integer default 0;
declare nidl1 integer default 0;
INSERT INTO eduarcom_bdverde2l.fe_art(descri,unid,prec,cost,premay,premen,pre3,peso,idcat,idmar,tipro,idflete,tmon,fechc,idpc,prod_come,
prod_comc,prod_uti1,prod_uti2,prod_uti3,prod_idus,prod_smin,prod_smax,prod_dola,prod_cod1)
VALUES (cdesc,cunid,nprec,ncosto,np1,np2,np3,npeso,ccat,cmar,ctipro,156,cm,localtime,
cidpc,ncome,ncomc,nutil1,nutil2,nutil3,nidusua,nsmin,nsmax,ndolar,ccodigo);
select last_insert_id() into nidl1 from eduarcom_bdverde2l.fe_art group by last_insert_id();
INSERT INTO fe_art(descri,unid,prec,cost,premay,premen,pre3,peso,idcat,idmar,tipro,idflete,tmon,fechc,idpc,prod_come,
prod_comc,prod_uti1,prod_uti2,prod_uti3,prod_idus,prod_smin,prod_smax,prod_dola,prod_enla,prod_cod1)
VALUES (cdesc,cunid,nprec,ncosto,np1,np2,np3,npeso,ccat,cmar,ctipro,nflete,cm,localtime,
cidpc,ncome,ncomc,nutil1,nutil2,nutil3,nidusua,nsmin,nsmax,ndolar,nidl1,ccodigo);
...
INSERT INTO eduarcom_bdverde2l.fe_prov(nruc,razo,dire,ciud,fono,fax,prov_rpm,email,refe,celu,prov_idus,idpcprov,fechprov)
VALUES (cruc,crazo,cdire,cciud,cfono,cfax,crpm,correo,crefe,ccelu,nidus,cpc,localtime);
return nid;
END */$$
DELIMITER ;
...
IF @ufc<=dfe then
   ...
   UPDATE eduarcom_bdverde2l.fe_art SET prec=npr,cost=npr*vigv,prod_idau=cnd,ulpc=idp,tmon=cmda,ulfc=dfe,
       premay=round(costor*@nutil1,2),premen=round(costor*@nutil2,2),pre3=if(@nutil3<>0,round(costor*@nutil3,2),0),
...
ncomc FLOAT,nidus INTEGER,ncoda INTEGER,nsmin FLOAT,nsmax FLOAT,ccodigo1 varchar(15),ndolar FLOAT,cestado CHAR,nutil0 DECIMAL(8,4))
BEGIN
