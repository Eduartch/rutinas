...
MySQL - 5.7.42 : Database - eduar_bdtaly
*********************************************************************
*/
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `AnulaMvtosBancos` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `AnulaMvtosBancos` AFTER UPDATE ON `fe_cbancos` FOR EACH ROW begin
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `AnulaPagosenCaja` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `AnulaPagosenCaja` AFTER UPDATE ON `fe_deu` FOR EACH ROW begin
...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `Anula` */$$

/*!50003 CREATE */ /*!50003 TRIGGER `Anula` AFTER UPDATE ON `fe_rcom` FOR EACH ROW begin
if new.acti='I' then
...
/*!50003 CREATE FUNCTION `FunCreaCLiente`(`cruc` VARCHAR(11), `crazo` VARCHAR(100), `cdire` VARCHAR(100), `cciud` VARCHAR(100), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cdni` VARCHAR(11), `ctipo` CHAR, `cemail` VARCHAR(45), `nidven` INTEGER, `nidus` INTEGER, `cpc` VARCHAR(45), `ccelu` VARCHAR(15), `crefe` VARCHAR(255), `linea` FLOAT, `crpm` VARCHAR(10), `nidz` INTEGER) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaCliPro`(`cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(60), `cfono` VARCHAR(10), `cfax` VARCHAR(10), `opt` INTEGER, `cdni` VARCHAR(10)) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
if opt=0 then
...
/*!50003 CREATE FUNCTION `FuncreaConceptosCaja`(`cdescri` VARCHAR(50), `ctipo` CHAR, `ctdoc` VARCHAR(3), `cusua` VARCHAR(45), `cidpc` VARCHAR(50), `norden` INTEGER, `idcon1` INTEGER) RETURNS int(10)
begin
...
/*!50003 CREATE FUNCTION `FunCreaEmpleado`(`crazo` VARCHAR(80), `cfono` VARCHAR(20), `nsueldo` FLOAT, `nidus` INTEGER, `cidpc` VARCHAR(45), `crefe` VARCHAR(80)) RETURNS int(11)
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunCreaFletes`(`cdescri` VARCHAR(45), `nprecio` FLOAT, `nidus` INTEGER, `cidpc` VARCHAR(45)) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaLinea`(`cdescri` VARCHAR(100), `nidus` INTEGER, `cidpc` VARCHAR(45), `nutil1` FLOAT, `nutil2` FLOAT, `nidgrupo` INTEGER) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaMarcas`(`cdescri` VARCHAR(100), `nidus` INTEGER, `cidpc` VARCHAR(45)) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaPlanCuentas`(`cn` VARCHAR(8), `cdes` VARCHAR(60), `cdd` VARCHAR(8), `cdh` VARCHAR(8), `cuenta` VARCHAR(12), `cope` CHAR) RETURNS int(11)
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FuncreaProductos`(`cdesc` VARCHAR(150), `cunid` VARCHAR(20), `nprec` FLOAT, `ncosto` FLOAT, `np1` FLOAT, `np2` FLOAT, `np3` FLOAT, `npeso` FLOAT, `ccat` INTEGER, `cmar` INTEGER, `ctipro` CHAR, `nflete` INTEGER, `cm` CHAR, `cidpc` VARCHAR(45), `ncome` FLOAT, `tigv` DECIMAL(6,3), `nutil1` FLOAT, `nutil2` FLOAT, `nutil3` FLOAT, `nidusua` INTEGER, `nsmin` FLOAT, `nsmax` FLOAT, `ccoda` VARCHAR(20), `ndolar` FLOAT) RETURNS int(11)
BEGIN
declare nid integer default 0;
INSERT INTO fe_art(descri,unid,prec,cost,premay,premen,pre3,peso,idcat,idmar,tipro,idflete,tmon,fechc,idpc,prod_come,
prod_tigv,prod_uti1,prod_uti2,prod_uti3,prod_idus,prod_smin,prod_smax,prod_cod1,prod_dola)
VALUES (cdesc,cunid,nprec,ncosto,np1,np2,np3,npeso,ccat,cmar,ctipro,nflete,cm,localtime,
cidpc,ncome,tigv,nutil1,nutil2,nutil3,nidusua,nsmin,nsmax,ccoda,ndolar);
...
/*!50003 CREATE FUNCTION `FuncreaProductos1`(`cdesc` VARCHAR(150), `cunid` VARCHAR(20), `nprec` FLOAT, `ncosto` FLOAT, `np1` FLOAT, `np2` FLOAT, `np3` FLOAT, `npeso` FLOAT, `ccat` INTEGER, `cmar` INTEGER, `ctipro` CHAR, `nflete` INTEGER, `cm` CHAR, `cidpc` VARCHAR(45), `nidgrupo` INTEGER, `ncome` FLOAT, `ncomc` FLOAT, `nutil1` FLOAT, `nutil2` FLOAT, `nutil3` FLOAT, `nidusua` INTEGER, `nsmin` FLOAT, `nsmax` FLOAT, `ccoda1` VARCHAR(6), `ndolar` FLOAT) RETURNS int(11)
BEGIN
declare nid integer default 0;
INSERT INTO fe_art(descri,unid,prec,cost,premay,premen,pre3,peso,idcat,idmar,tipro,idflete,tmon,fechc,idpc,prod_come,
...
/*!50003 CREATE FUNCTION `FunCreaProveedor`(`cruc` VARCHAR(11), `crazo` VARCHAR(100), `cdire` VARCHAR(100), `cciud` VARCHAR(100), `cfono` VARCHAR(10), `cfax` VARCHAR(10), `crpm` VARCHAR(10), `correo` VARCHAR(45), `crefe` VARCHAR(200), `ccelu` VARCHAR(10), `nidus` INTEGER, `cpc` VARCHAR(45)) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunHayTraspaso`(`cdcto` VARCHAR(12), `ctdoc` VARCHAR(2), `nidauto` INTEGER) RETURNS int(11)
BEGIN
DECLARE sw INTEGER DEFAULT 0;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET sw=0;
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraCotizacion`(`dfech` DATETIME, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `cusua` INTEGER, `cidpcped` VARCHAR(45), `nidven` INTEGER, `nidtienda` INTEGER, `ctp` CHAR, `caten` VARCHAR(80), `cforma` VARCHAR(80), `cplazo` VARCHAR(80), `cvalidez` VARCHAR(80), `centrega` VARCHAR(80), `cdetalle` VARCHAR(150), `cmone` CHAR) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraCotizacion1`(`dfech` DATETIME, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `cusua` INTEGER, `cidpcped` VARCHAR(45), `nidven` INTEGER, `nidtienda` INTEGER, `ctp` CHAR, `caten` VARCHAR(80), `cforma` VARCHAR(80), `cplazo` VARCHAR(80), `cvalidez` VARCHAR(80), `centrega` VARCHAR(80), `cdetalle` VARCHAR(150), `cmone` CHAR) RETURNS int(11)
BEGIN
declare nid integer default 0;
INSERT INTO fe_rped(fech,idclie,ndoc,tdoc,impo,form,rped_idus,idpcped,fecho,idven,idtienda,tipopedido,aten,forma,plazo,validez,entrega,detalle,rped_mone)
VALUES(dfech,nidclie,cndoc,ctdoc,nimpo,cform,cusua,cidpcped,localtime,nidven,nidtienda,ctp,caten,cforma,cplazo,cvalidez,centrega,cdetalle,cmone);
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraCV`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` FLOAT, `nigv` FLOAT, `nt` FLOAT, `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `npvta` FLOAT) RETURNS int(11)
BEGIN
declare nid integer;
declare ctipo char;
set nid=0;
if opt=0 then
   ...
   if ni>1 then
     ...
     INSERT INTO fe_rcom(tdoc,form,ndoc,fech,fecr,deta,rcom_exon,igv,impo,ndo2,mone,
     dolar,vigv,tcom,idprov,tipom,fusua,idusua,codt,rcom_nitem,rcom_tipo,pimpo,rcom_fech)
     VALUES (ctdoc,cform,cndoc,dfecha,dfechar,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,
     ni,ctg,ccodp,cmvto,localtime,nus,nidcodt,nitem,ctipo,npvta,dfecha);
     select last_insert_id() into nid from fe_rcom group by last_insert_id();
     if n1>0 and n2>0 and n3>0 then
         call IngresaCuentas(0,0,0,0,nigv,nv,0,nt,n1,0,0,0,n2,0,0,n3,"D","","","","D","","","H",nid);
     end if;
    end if;
  else
   if ctdoc='20' then
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraCVtas`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` FLOAT, `nigv` FLOAT, `nt` FLOAT, `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `npvta` DECIMAL(12,2), `nvendedor` INTEGER) RETURNS int(11)
BEGIN
declare nid,ntdoc,idve,nidctaper integer;
declare ctipo char;
set ntdoc=0;
set nid=0;
   INSERT INTO fe_rcom(tdoc,form,ndoc,fech,fecr,deta,valor,igv,impo,ndo2,mone,dolar,vigv,tcom,idcliente,tipom,fusua,idusua,codt,rcom_nitem,pimpo,rcom_vend)
   VALUES (ctdoc,cform,cndoc,dfecha,dfecha,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,ni,ctg,ccodp,cmvto,localtime,nus,nidcodt,nitem,npvta,nvendedor);
   select last_insert_id() into nid from fe_rcom group by last_insert_id();
   if n1>0 and n2>0 and n3>0 then
      call IngresaCuentasV(nv,nigv,nt,n1,n2,n3,"H","H","D",nid);
   end if;
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraPedido`(`dfech` DATE, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `nidus` INTEGER, `cidpcped` VARCHAR(45), `nidven` INTEGER, `nidtienda` INTEGER, `ctipop` CHAR) RETURNS int(11)
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraTraspasoN`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` FLOAT, `nigv` FLOAT, `nt` FLOAT, `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `npvta` FLOAT, `copt` CHAR) RETURNS int(11)
BEGIN
DECLARE nid INTEGER;
...
n1 INTEGER,n2 INTEGER,n3 INTEGER,nitem DECIMAL(12,2),npvta FLOAT,nicbper DECIMAL(6,2),direcenvio varchar(250)) RETURNS int(11)
BEGIN
DECLARE nid INTEGER DEFAULT 0;
DECLARE ctipo CHAR;
SET nid=0;
INSERT INTO fe_rcom(tdoc,form,ndoc,fech,fecr,deta,valor,igv,impo,ndo2,mone,
dolar,vigv,tcom,idcliente,tipom,fusua,idusua,codt,rcom_tipo,pimpo,rcom_fech,rcom_icbper,rcom_exon,direccionenvio)
VALUES (ctdoc,cform,cndoc,dfecha,dfecha,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,ni,
ctg,ccodp,cmvto,LOCALTIME,nus,nidcodt,ctipo,npvta,dfecha,nicbper,nv,direcenvio);
SELECT LAST_INSERT_ID() INTO nid FROM fe_rcom GROUP BY LAST_INSERT_ID();
IF n1>0 AND n2>0 AND n3>0 THEN
   CALL IngresaCuentasV(nv,nigv,nt,n1,n2,n3,"H","H","D",nid);
END IF;
...
/*!50003 CREATE FUNCTION `FunIngresaCaja`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(12), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INT, `ide` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
if cajas='A' then
...
/*!50003 CREATE FUNCTION `FunIngresaCaja1`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(12), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INT, `ide` INTEGER, `si` CHAR) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaCajaBancos`(`idb` INTEGER, `dfecha` DATE, `nop` VARCHAR(20), `idmp` INTEGER, `cdeta` VARCHAR(120), `idpr` INTEGER, `idcl` INTEGER, `cndoc` VARCHAR(20), `idcta` INTEGER, `debe` DECIMAL(12,2), `haber` DECIMAL(12,2), `norden` INTEGER, `nidclpr` INTEGER) RETURNS int(11)
BEGIN
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaCajaBancos1`(`idb` INTEGER, `dfecha` DATE, `nop` VARCHAR(20), `idmp` INTEGER, `cdeta` VARCHAR(120), `idpr` INTEGER, `idcl` INTEGER, `cndoc` VARCHAR(20), `idcta` INTEGER, `debe` DECIMAL(12,2), `haber` DECIMAL(12,2), `norden` INTEGER, `nidclpr` INTEGER, `ctipo` CHAR) RETURNS int(11)
BEGIN
declare id integer;
insert into fe_cbancos(cban_idba,cban_nume,cban_fech,cban_idmp,cban_deta,cban_idpr,cban_idcl,cban_ndoc,cban_idct,
...
/*!50003 CREATE FUNCTION `FunIngresaCajaBancosT`(`idb` INTEGER, `dfecha` DATE, `nop` VARCHAR(20), `idmp` INTEGER, `cdeta` VARCHAR(120), `idpr` INTEGER, `idcl` INTEGER, `cndoc` VARCHAR(20), `idcta` INTEGER, `debe` DECIMAL(12,2), `haber` DECIMAL(12,2), `norden` INTEGER, `nidclpr` INTEGER) RETURNS int(11)
BEGIN
declare id integer;
insert into fe_cbancos(cban_idba,cban_nume,cban_fech,cban_idmp,cban_deta,cban_idpr,cban_idcl,cban_ndoc,cban_idct,
...
/*!50003 CREATE FUNCTION `FunIngresaCajaBancosTran`(`idb` INTEGER, `dfecha` DATE, `nop` VARCHAR(20), `idmp` INTEGER, `cdeta` VARCHAR(120), `idpr` INTEGER, `idcl` INTEGER, `cndoc` VARCHAR(20), `idcta` INTEGER, `debe` DECIMAL(12,2), `haber` DECIMAL(12,2), `norden` INTEGER, `nidclpr` INTEGER) RETURNS int(11)
BEGIN
declare id integer;
insert into fe_cbancos(cban_idba,cban_nume,cban_fech,cban_idmp,cban_deta,cban_idpr,cban_idcl,cban_ndoc,cban_idct,
...
/*!50003 CREATE FUNCTION `FunIngresaCajaE`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(12), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INT, `ide` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaCajaVendedor`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(10), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INTEGER, `ide` INTEGER, `nidv` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaCajaVendedortmp`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(15), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INTEGER, `ide` INTEGER, `nidv` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaCajaVtas`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(12), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INT, `ide` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
if cajas='A' then
...
/*!50003 CREATE FUNCTION `FunIngresaCheques`(`nidb` INTEGER, `cnumero` VARCHAR(45), `dfechag` DATE, `dfechac` DATE, `cmone` CHAR, `nimpo` FLOAT, `nidch` INTEGER, `nidus` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunIngresaCostos`(`ncosto` FLOAT, `nidauto` INTEGER, `nidart` INTEGER, `nflete` FLOAT, `nprec` FLOAT, `cmone` CHAR, `ndola` FLOAT, `dfecha` DATE) RETURNS int(11)
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunIngresaCreditos`(`nauto` INTEGER, `nidcl` INTEGER, `cndoc` VARCHAR(12), `cest` CHAR, `cmon` CHAR, `crefe` VARCHAR(120), `dfecha` DATE, `dfevto` DATE, `ctipo` CHAR, `cdocp` VARCHAR(12), `ndolar` FLOAT, `csitua` VARCHAR(2), `nimpo` FLOAT, `ni` FLOAT, `idven` INTEGER, `nimpoo` FLOAT, `cusua` INTEGER, `nidaval` INTEGER, `ndscto` FLOAT, `cpc` VARCHAR(50), `nidcodt` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaE`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER) RETURNS int(11)
begin
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaE1`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER) RETURNS int(11)
begin
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaECreditos`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15)) RETURNS int(11)
begin
declare nid integer;
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaEDeudas`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15)) RETURNS int(11)
begin
declare nid integer;
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaEe`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER) RETURNS int(11)
begin
declare id integer;
if sdeudor>0 then
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLibroDiario`(`dfech` DATETIME, `ndebe` DECIMAL(12,2), `nhaber` DECIMAL(12,2), `cglosa` VARCHAR(120), `ct` CHAR(1), `cnume` VARCHAR(10), `nidcta` INTEGER, `ccond` CHAR, `nit` INTEGER, `ncomp` VARCHAR(15), `nidcl` INTEGER, `nidpr` INTEGER, `cmone` CHAR, `ctran` CHAR, `nimtd` DECIMAL(12,2), `nimth` DECIMAL(12,2)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaDCreditos`(`dfecha` DATETIME, `dfevto` DATETIME, `nimpo` FLOAT, `cndoc` VARCHAR(10), `cest` CHAR, `cmon` CHAR, `crefe` VARCHAR(120), `ctipo` CHAR, `id1` INTEGER, `nidus` INTEGER) RETURNS int(11)
BEGIN
declare id integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaDeudas`(`nidrd` INTEGER, `cndoc` VARCHAR(12), `cest` CHAR, `dfecha` DATE, `dfevto` DATE, `ctipo` CHAR, `ndolar` FLOAT, `nimpo` FLOAT, `cusua` INTEGER, `cpc` VARCHAR(50), `nidcodt` INTEGER, `cnrou` VARCHAR(15), `cdeta` VARCHAR(80), `csitua` VARCHAR(2)) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaDkardex`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `ccodv` INTEGER, `ct1` CHAR, `nidtda` INTEGER) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `FuningresaDocumentoElectronico`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `cdetalle` VARCHAR(220), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` DECIMAL(6,4), `ni` DECIMAL(6,4), `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nvend` INTEGER, `idtr` DECIMAL(10,2), `nexon` DECIMAL(12,2), `ndscto` DECIMAL(12,2)) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
   INSERT INTO fe_rcom(tdoc,form,ndoc,fech,fecr,deta,valor,igv,impo,ndo2,mone,dolar,vigv,tcom,idcliente,
   tipom,fusua,idusua,codt,pimpo,rcom_exon,rcom_dsct,rcom_vend)
   VALUES (ctdoc,cform,cndoc,dfecha,dfecha,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,ni,ctg,ccodp,cmvto,localtime,nus,nidcodt,
   idtr,nexon,ndscto,nvend);
   select last_insert_id() into nid from fe_rcom group by last_insert_id();
   if n1>0 and n2>0 and n3>0 then
      call IngresaCuentasV(nv,nigv,nt,n1,n2,n3,"H","H","D",nid);
end if;
...
/* Function  structure for function  `FuningresaDocumentoElectronicoVtas` */

/*!50003 DROP FUNCTION IF EXISTS `FuningresaDocumentoElectronicoVtas` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `FuningresaDocumentoElectronicoVtas`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `cdetalle` VARCHAR(220), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` DECIMAL(6,4), `ni` DECIMAL(6,4), `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `idtr` DECIMAL(10,2), `nexon` DECIMAL(12,2), `ndscto` DECIMAL(12,2), `nvend` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
   INSERT INTO fe_rcom(tdoc,form,ndoc,fech,fecr,deta,valor,igv,impo,ndo2,mone,dolar,vigv,tcom,idcliente,
   tipom,fusua,idusua,codt,pimpo,rcom_exon,rcom_dsct,rcom_vend,rcom_dias,rcom_vend)
   VALUES (ctdoc,cform,cndoc,dfecha,dfecha,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,ni,ctg,ccodp,cmvto,localtime,nus,nidcodt,
   idtr,nexon,ndscto,nvend);
   select last_insert_id() into nid from fe_rcom group by last_insert_id();
 if n1>0 and n2>0 and n3>0 then
...
/*!50003 CREATE FUNCTION `FunIngresaGuiasCons`(`dfecha` DATE, `cptop` VARCHAR(100), `cptoll` VARCHAR(100), `nidauto` INTEGER, `dfechat` DATE, `nidus` INTEGER, `cdeta` VARCHAR(150), `nidtr` INTEGER, `cndoc` VARCHAR(10), `cmoti` CHAR) RETURNS int(11)
BEGIN
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaGuiasxComprasRemitente`(`dfecha` DATETIME, `cptop` VARCHAR(100), `cptoll` VARCHAR(150), `nidauto` INTEGER, `dfechat` DATETIME, `nidus` INTEGER, `cdeta` VARCHAR(150), `nidtr` INTEGER, `cndoc` VARCHAR(12), `nidtda` INTEGER, `cdcto` VARCHAR(12), `df` DATE) RETURNS int(11)
BEGIN
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaGuiasXdCompras`(`dfecha` DATETIME, `cptop` VARCHAR(100), `cptoll` VARCHAR(150), `nidauto` INTEGER, `dfechat` DATETIME, `nidus` INTEGER, `cdeta` VARCHAR(150), `nidtr` INTEGER, `cndoc` VARCHAR(12), `nidtda` INTEGER) RETURNS int(11)
BEGIN
declare id integer;
insert into fe_guias(guia_fech,guia_ptop,guia_ptoll,guia_idau,guia_fect,guia_idus,guia_fope,guia_deta,guia_idtr,guia_ndoc,guia_moti,guia_codt)
values(dfecha,cptop,cptoll,nidauto,dfechat,nidus,localtime,cdeta,nidtr,cndoc,'D',nidtda);
select last_insert_id() into id from  fe_guias group by last_insert_id();
return id;
END */$$
DELIMITER ;
...
/*!50003 CREATE FUNCTION `FunIngresaKardex`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `ccodv` INTEGER, `ct1` CHAR, `cdeta` VARCHAR(50), `nidtda` INTEGER, `nidtda1` INTEGER, `na1` INTEGER) RETURNS int(11)
BEGIN
declare nidk integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaKardex1`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `tmvto` CHAR, `ccodv` INTEGER, `calma` INTEGER, `nidcosto1` INTEGER, `vcom` FLOAT) RETURNS int(11)
BEGIN
declare nidk integer default 0;
if ct='C' then
...
/*!50003 CREATE FUNCTION `FunIngresaKardexCambios`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cin` CHAR, `ccodv` INTEGER, `ctt` CHAR, `nidtda` INTEGER, `nidcosto` INTEGER) RETURNS int(11)
BEGIN
declare nidk integer default 0;
...
BEGIN
DECLARE nidk INTEGER DEFAULT 0;
INSERT INTO fe_kar(idauto,idart,tipo,prec,cant,ttip,incl,alma,kar_cost,codv,kar_alma1,kar_comi,estadoenvio)
VALUES (nid,cc,'V',npr,nct,tmvto,cincl,calma,nidcosto1,ccodv,0,vcom,'D');
SELECT LAST_INSERT_ID() INTO nidk FROM fe_kar GROUP BY LAST_INSERT_ID();
RETURN nidk;
END */$$
DELIMITER ;
...
/*!50003 CREATE FUNCTION `FUNINGRESANOTASCREDITOventas1`(`nid0` INTEGER, `nid1` INTEGER, `nidpagos` INTEGER) RETURNS int(11)
BEGIN
declare id integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaOrdenCompra`(`dfecha` DATE, `nidpr` INTEGER, `cmone` CHAR, `cndoc` VARCHAR(10), `ctigv` CHAR, `cobse` VARCHAR(200), `caten` VARCHAR(80), `cdeta` VARCHAR(200), `cidpc` VARCHAR(45), `nidus` INTEGER, `cdespacho` VARCHAR(60), `cforma` VARCHAR(60), `nv` FLOAT, `nigv` FLOAT, `nimpo` FLOAT) RETURNS int(11)
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditos`(`cndoc` VARCHAR(12), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditosCb`(`cndoc` VARCHAR(10), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER, `idcb` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditosCe`(`cndoc` VARCHAR(12), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER, `idce` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditosCefectivo`(`cndoc` VARCHAR(12), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER, `idcaja` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
INSERT INTO fe_cred(fech,fevto,acta,ndoc,estd,mone,banc,tipo,cred_idrc,cred_idus,cred_fope,ncontrol,nrou,cred_idpc,cred_idce)
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditosDiario`(`cndoc` VARCHAR(10), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER, `idiario` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditostmp`(`cndoc` VARCHAR(12), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudas`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(10), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudas1`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(12), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT, `ninteres` DECIMAL(10,2)) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudasCb`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(10), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT, `idcb` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudasCE`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(10), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT, `idce` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudasDiario`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(10), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` DECIMAL(6,4), `idiario` INTEGER) RETURNS int(11)
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosEmpleados`(`nimpo` FLOAT, `nacta` FLOAT, `dfech` DATE, `ct` CHAR, `nidus` INTEGER, `nidcaja` INTEGER, `nidem` INTEGER, `cdeta` VARCHAR(100)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaRCompras`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `npvta` FLOAT, `nexon` DECIMAL(12,2), `notros` DECIMAL(12,2)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaRcreditos`(`nauto` INTEGER, `nid` INTEGER, `dfecha` DATETIME, `nidven` INTEGER, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `ninic` FLOAT, `cpc` VARCHAR(45)) RETURNS int(11)
BEGIN
...
/*!50003 CREATE FUNCTION `FunRegistraCreditos`(`nauto` INTEGER, `nid` INTEGER, `cndoc` VARCHAR(12), `cest` CHAR, `cmon` CHAR, `crefe` VARCHAR(60), `dfecha` DATE, `dfevto` DATE, `ctipo` CHAR, `cdocp` VARCHAR(12), `nimpo` FLOAT, `ninic` FLOAT, `idven` INTEGER, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `cpc` VARCHAR(45)) RETURNS int(11)
BEGIN
DECLARE id INTEGER DEFAULT 0;
DECLARE id1 INTEGER DEFAULT 0;
INSERT INTO fe_rcred(rcre_idcl,rcre_fech,rcre_idau,rcre_impc,rcre_idus,rcre_codt,rcre_idpc,rcre_inic,rcre_codv)
...
/*!50003 CREATE FUNCTION `FunRegistraDeudas`(`nauto` INTEGER, `nid` INTEGER, `cmon` CHAR, `dfecha` DATE, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `cpc` VARCHAR(45)) RETURNS int(11)
BEGIN
declare id integer default 0;
...
/*!50003 CREATE FUNCTION `FunRegistraDeudasCCtas`(`nauto` INTEGER, `nid` INTEGER, `cmon` CHAR, `dfecha` DATE, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `cpc` VARCHAR(45), `nidcta` INTEGER) RETURNS int(11)
BEGIN
declare id integer default 0;
...
/* Function  structure for function  `FunRegistraRSeries` */

/*!50003 DROP FUNCTION IF EXISTS `FunRegistraRSeries` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `FunRegistraRSeries`(`cserie` VARCHAR(60), `nidauto` INTEGER) RETURNS int(11)
Begin
Declare nid integer default 0;
insert into fe_rseries(rser_seri,rser_idau)values(cserie,nidauto);
select last_insert_id() into nid from fe_rseries group by last_insert_id();
return nid;
End */$$
DELIMITER ;
...
/*!50003 CREATE FUNCTION `FunTraspasoDatosLcajaE`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER) RETURNS int(11)
begin
declare id integer;
...
/*!50003 CREATE FUNCTION `FunverificaNombredeProducto`(`cdescri` VARCHAR(100), `nid` INTEGER) RETURNS int(1)
BEGIN
declare sw integer;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET sw=0;
if nid=0 then
     select idart into sw from fe_art where trim(descri)=(cdescri) and prod_acti='A' group by idart;
else
   select idart into sw from fe_art where trim(descri)=(cdescri) and prod_acti='A' and idart<>nid group by idart;
end if;
if sw>0 then
   return 0;
else
...
/* Function  structure for function  `FunVerificaPagos1` */

/*!50003 DROP FUNCTION IF EXISTS `FunVerificaPagos1` */;
DELIMITER $$

/*!50003 CREATE FUNCTION `FunVerificaPagos1`(`nid` INTEGER) RETURNS int(11)
BEGIN
DECLARE sw,sw1 INTEGER;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET sw=0,sw1=0;
SET sw:=(SELECT COUNT(rcre_idau) FROM fe_cred AS b INNER JOIN fe_rcred AS a
...
/* Procedure structure for procedure `FunRDRSeries` */

/*!50003 DROP PROCEDURE IF EXISTS  `FunRDRSeries` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `FunRDRSeries`(`nidre` INTEGER, `nidkar` INTEGER, `nidart` INTEGER)
Begin
insert into fe_dseries(dser_idre,dser_idka,dser_idar)values(nidre,nidkar,nidart);
End */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ingresacaja`(IN `nauto` INTEGER, IN `cdcto` VARCHAR(12), IN `dfecha` DATE, IN `nimpo` FLOAT, IN `nimpo1` FLOAT, IN `cdeta` VARCHAR(120), IN `nidus` INTEGER, IN `cmon` CHAR, IN `idcreditos` INTEGER, IN `cf` CHAR, IN `nimporte1` FLOAT, IN `cmon1` CHAR, IN `ndola1` FLOAT, IN `cidpc` VARCHAR(50), IN `nidtda` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `IngresaCuentas`(`nv1` DECIMAL(12,2), `nv2` DECIMAL(12,2), `nv3` DECIMAL(12,2), `nv4` DECIMAL(12,2), `nv5` DECIMAL(12,2), `nv6` DECIMAL(12,2), `nv7` DECIMAL(12,2), `nv8` DECIMAL(12,2), `nid1` INTEGER, `nid2` INTEGER, `nid3` INTEGER, `nid4` INTEGER, `nid5` INTEGER, `nid6` INTEGER, `nid7` INTEGER, `nid8` INTEGER, `ct1` CHAR, `ct2` CHAR, `ct3` CHAR, `ct4` CHAR, `ct5` CHAR, `ct6` CHAR, `ct7` CHAR, `ct8` CHAR(1), `nid` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `IngresaCuentasv`(`nv1` DECIMAL(12,2), `nv2` DECIMAL(12,2), `nv3` DECIMAL(12,2), `nid1` INTEGER, `nid2` INTEGER, `nid3` INTEGER, `ct1` CHAR, `ct2` CHAR, `ct3` CHAR, `nid` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCabeceraCV`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitems` INTEGER, `npvta` FLOAT, `nidauto` INTEGER)
BEGIN
declare nidctaper integer;
if opt=0 then
    if ni>1 then
      ...
      mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,idprov=ccodp,tipom=cmvto,idusua1=nus,codt=nidcodt,rcom_exon=0 where idauto=nidauto;
      ...
      update fe_rcom set tdoc=ctdoc,form=cform,ndoc=cndoc,fech=dfecha,fecr=dfechar,deta=cdetalle,rcom_exon=nv,valor=0,igv=nigv,impo=nt,ndo2=cndo2,
      mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,idprov=ccodp,tipom=cmvto,idusua1=nus,codt=nidcodt where idauto=nidauto;
      call ProDesactivaLcajaE(nidauto);
      if n1>0 and n2>0 and n3>0 then
        select @id1:=sum(x.nid1),@id5:=sum(x.nid2),@id6:=sum(x.nid3),@id8:=sum(x.nid4)
        from (select case nitem when 1 then idectas else 0 end as nid1,
        ...
        from fe_ectasc where idrcon=nidauto) as x group by idrcon;
        if @id1>0 then
           call ProActualizaCuentasc(0,0,0,0,nigv,nv,0,nt,n1,0,0,0,n2,0,0,n3,@id1,@id5,@id6,@id8,"D","D","","H");
        else
           call IngresaCuentas(0,0,0,0,nigv,nv,0,nt,n1,0,0,0,n2,0,0,n3,"D","","","","D","","","H",nidauto);
        end if;
      end if;
     end if;
  else
   ...
   mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,idcliente=ccodp,tipom=cmvto,idusua1=nus,codt=nidcodt where idauto=nidauto;
    ...
    UPDATE fe_rcom SET tdoc=ctdoc,form=cform,ndoc=cndoc,fech=dfecha,fecr=dfechar,deta=cdetalle,valor=0,rcom_exon=nv,igv=nigv,impo=nt,ndo2=cndo2,
   mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,idcliente=ccodp,tipom=cmvto,idusua1=nus,codt=nidcodt WHERE idauto=nidauto;
   end if;   
   call ProDesactivaLcajaE(nidauto);
   if n1>0 and n2>0 and n3>0 then
...
ctdoc VARCHAR(2),cform CHAR,cndoc VARCHAR(12),dfecha DATE,cgarantia VARCHAR(50),cdetalle VARCHAR(120),
nv DECIMAL(12,2),nigv DECIMAL(12,2),nt DECIMAL(12,2),cndo2 VARCHAR(10),cm CHAR,
ndolar FLOAT,ni FLOAT,ctg CHAR,ccodp INTEGER,nexon DECIMAL(12,2),nus INTEGER,opt INTEGER,nidcodt INTEGER,
n1 INTEGER,n2 INTEGER,n3 INTEGER,nretencion DECIMAL(8,2),npvta FLOAT,nidauto INTEGER,nidv integer)
BEGIN
  UPDATE fe_rcom SET tdoc=ctdoc,form=cform,ndoc=cndoc,fech=dfecha,fecr=dfecha,deta=cdetalle,valor=nv,igv=nigv,impo=nt,ndo2=cndo2,
   mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,idcliente=ccodp,tipom='V',idusua1=nus,codt=nidcodt,rcom_mret=nretencion,
   rcom_nitem=cgarantia,rcom_vend=nidv WHERE idauto=nidauto;
   IF n1>0 AND n2>0 AND n3>0 THEN
...
/*!50003 CREATE PROCEDURE `ProActualizaCabeceraPedido`(`dfech` DATE, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `nidven` INTEGER, `nidauto` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCabeceraTraspasoN`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` FLOAT, `nigv` FLOAT, `nt` FLOAT, `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `npvta` FLOAT, `copt` CHAR, `nauto` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCaja`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(12), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `nidcaja` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCajaBancos`(`idb` INTEGER, `dfecha` DATE, `nope` VARCHAR(20), `idmp` INTEGER, `cdeta` VARCHAR(120), `idpr` INTEGER, `idcl` INTEGER, `cndoc` VARCHAR(20), `idcta` INTEGER, `debe` FLOAT, `haber` FLOAT, `norden` INTEGER, `id` INTEGER, `opt` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCliente`(`nid` INTEGER, `cruc` VARCHAR(11), `crazo` VARCHAR(100), `cdire` VARCHAR(100), `cciud` VARCHAR(100), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cdni` VARCHAR(11), `ctipo` CHAR, `cemail` VARCHAR(45), `nidven` INTEGER, `nidus` INTEGER, `ccelu` VARCHAR(15), `crefe` VARCHAR(255), `linea` FLOAT, `crpm` VARCHAR(10), `nidz` INTEGER)
BEGIN
update fe_clie set
...
/*!50003 CREATE PROCEDURE `ProActualizaCostos`(`nidcosto` INTEGER, `ncosto` FLOAT, `nflete` FLOAT, `nprecio` FLOAT, `cmoneda` CHAR, `ndolar` FLOAT)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCotizacion`(`dfech` DATETIME, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `cusua` INTEGER, `nidven` INTEGER, `nidtienda` INTEGER, `ctp` CHAR, `caten` VARCHAR(80), `cforma` VARCHAR(80), `cplazo` VARCHAR(80), `cvalidez` VARCHAR(80), `centrega` VARCHAR(80), `cdetalle` VARCHAR(150), `cmone` CHAR, `nidauto` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCotizacion1`(`dfech` DATETIME, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `cusua` INTEGER, `nidven` INTEGER, `nidtienda` INTEGER, `ctp` CHAR, `caten` VARCHAR(80), `cforma` VARCHAR(80), `cplazo` VARCHAR(80), `cvalidez` VARCHAR(80), `centrega` VARCHAR(80), `cdetalle` VARCHAR(150), `cmone` CHAR, `nidauto` INTEGER)
BEGIN
UPDATE fe_rped SET fech=dfech,idclie=nidclie,ndoc=cndoc,impo=nimpo,form=cform,idven=nidven,facturado='N',tdoc=ctdoc,
tipopedido='P',aten=caten,forma=cforma,plazo=cplazo,validez=cvalidez,entrega=centrega,detalle=cdetalle WHERE idautop=nidauto;
END */$$
...
/*!50003 CREATE PROCEDURE `ProActualizaCtasc`(IN `nv1` DECIMAL(12,2), IN `nv2` FLOAT, IN `nv3` FLOAT, IN `nv4` FLOAT, IN `nv5` FLOAT, IN `nv6` FLOAT, IN `nv7` FLOAT, IN `nv8` DECIMAL(12,2), IN `nid1` INTEGER, IN `nid2` INTEGER, `nid3` INTEGER, IN `nid4` INTEGER, IN `nid5` INTEGER, `nid6` INTEGER, IN `nid7` INTEGER, IN `nid8` INTEGER, IN `idv1` INTEGER, IN `idv2` INTEGER, IN `idv3` INTEGER, IN `idv4` INTEGER, IN `idv5` INTEGER, IN `idv6` INTEGER, IN `idv7` INTEGER, IN `idv8` INTEGER, IN `ct1` CHAR, IN `ct2` CHAR, IN `ct3` CHAR, IN `ct4` CHAR, IN `ct5` CHAR, IN `ct6` CHAR, IN `ct7` CHAR, `ct8` CHAR)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCuentasc`(IN `nv1` DECIMAL(12,2), IN `nv2` DECIMAL(12,2), IN `nv3` DECIMAL(12,2), IN `nv4` DECIMAL(12,2), IN `nv5` DECIMAL(12,2), IN `nv6` DECIMAL(12,2), IN `nv7` DECIMAL(12,2), IN `nv8` DECIMAL(12,2), IN `nid1` INTEGER, IN `nid2` INTEGER, `nid3` INTEGER, IN `nid4` INTEGER, IN `nid5` INTEGER, `nid6` INTEGER, IN `nid7` INTEGER, IN `nid8` INTEGER, IN `idv1` INTEGER, IN `idv2` INTEGER, IN `idv3` INTEGER, IN `idv4` INTEGER, IN `ct1` CHAR, IN `ct2` CHAR, IN `ct3` CHAR, IN `ct4` CHAR)
BEGIN
update fe_ectasc set impo=nv1,idcta=nid1,ecta_tipo=ct1 where idectas=idv1;
...
/*!50003 CREATE PROCEDURE `ProActualizaCuentasv`(IN `nv1` DECIMAL(12,2), IN `nv2` DECIMAL(12,2), IN `nv3` DECIMAL(12,2), IN `nid1` INTEGER, IN `nid2` INTEGER, `nid3` INTEGER, IN `idv1` INTEGER, IN `idv2` INTEGER, IN `idv3` INTEGER, `ct1` CHAR, `ct2` CHAR, `ct3` CHAR)
BEGIN
...
/*!50003 CREATE PROCEDURE `PROACTUALIZADATOSDIARIO`(`dfech` DATETIME, `ndebe` DECIMAL(12,2), `nhaber` DECIMAL(12,2), `cglosa` VARCHAR(120), `ct` CHAR(1), `cnume` VARCHAR(10), `nidcta` INTEGER, `idd` INTEGER, `opt` INTEGER, `ccond` CHAR, `nit` INTEGER, `ncomp` VARCHAR(15), `nidcl` INTEGER, `nidpr` INTEGER, `cmone` CHAR, `ctran` CHAR)
BEGIN
if opt=0 then
...
/*!50003 CREATE PROCEDURE `ProActualizaDatosLcajaE`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `nid` INTEGER, `opt` INTEGER, `cmone` CHAR, `ndolar` DECIMAL(5,3))
begin
if opt=0 then
...
/*!50003 CREATE PROCEDURE `ProActualizaDatosLcajaE1`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `nidauto` INTEGER, `cmone` CHAR, `ndolar` DECIMAL(5,3), `idcl` INTEGER)
begin
update fe_lcaja  set lcaj_fech=dfecha,lcaj_ndoc=cndoc,lcaj_deta=cdeta,lcaj_idct=idcta,
...
/*!50003 CREATE PROCEDURE `ProActualizaGuiasCons`(`dfecha` DATE, `cptop` VARCHAR(100), `cptoll` VARCHAR(100), `nidauto` INTEGER, `dfechat` DATE, `nidus` INTEGER, `cdeta` VARCHAR(150), `nidtr` INTEGER, `cndoc` VARCHAR(10), `nidg` INTEGER)
Begin
...
/*!50003 CREATE PROCEDURE `ProActualizaKardex1`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `tmvto` CHAR, `ccodv` INTEGER, `calma` INTEGER, `nidcosto1` INTEGER, `nidkar` INTEGER, `op` INTEGER, `xcom` FLOAT)
BEGIN
if op=0 then
...
/*!50003 CREATE PROCEDURE `ProActualizaMargenesVta`(`nu1` DECIMAL(8,3), `nu2` DECIMAL(8,3), `nu3` DECIMAL(8,3), `nidart` INTEGER)
begin
...
/*!50003 CREATE PROCEDURE `ProActualizaOrdenCompra`(`dfecha` DATE, `nidpr` INTEGER, `cmone` CHAR, `cndoc` VARCHAR(10), `ctigv` CHAR, `cobse` VARCHAR(200), `caten` VARCHAR(80), `cdeta` VARCHAR(200), `nidus` INTEGER, `nid` INTEGER, `cdespacho` VARCHAR(60), `cforma` VARCHAR(60), `nv` FLOAT, `nigv` FLOAT, `nimpo` FLOAT)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaPlanCuentas`(`cn` VARCHAR(8), `cdes` VARCHAR(60), `cdd` VARCHAR(8), `cdh` VARCHAR(8), `cuenta` VARCHAR(12), `cope` CHAR, `nid` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaPreciosProducto`(`cc` INTEGER, `dfe` DATE, `npr` FLOAT, `cnd` INTEGER, `idp` INTEGER, `cmda` CHAR, `nigv` DECIMAL(6,3), `ndolar` DECIMAL(5,3), `nidcosto` INTEGER)
BEGIN
...
IF @ufc<=dfe then
   ...
   set costor=round((npr*nigv)+@ncostof,2);
   UPDATE fe_art SET prec=npr,cost=npr*nigv,prod_idau=cnd,ulpc=idp,tmon=cmda,ulfc=dfe,
   premay=round(costor*@nutil1,2),premen=round(costor*@nutil2,2),pre3=if(@nutil3<>0,round(costor*@nutil3,2),0),
   prod_idco=nidcosto,prod_dola=ndolar,prod_tigv=nigv WHERE idart=cc;
end if;
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProActualizaPreciosProductoCdscto`(`cc` INTEGER, `dfe` DATE, `npr` FLOAT, `idp` INTEGER, `cmda` CHAR)
BEGIN
declare costor float;
declare vigv float;
...
/*!50003 CREATE PROCEDURE `ProActualizaProductos`(`cdesc` VARCHAR(150), `cunid` VARCHAR(20), `ncosto` FLOAT, `np1` FLOAT, `np2` FLOAT, `np3` FLOAT, `npeso` FLOAT, `ccat` INTEGER, `cmar` INTEGER, `ctipro` CHAR, `nflete` INTEGER, `cm` CHAR, `nprecio` FLOAT, `ccoda` VARCHAR(20), `nutil1` FLOAT, `nutil2` FLOAT, `nutil3` FLOAT, `ncome` FLOAT, `ncomc` FLOAT, `nidus` INTEGER, `ncoda` INTEGER, `nsmin` FLOAT, `nsmax` FLOAT, `tigv` DECIMAL(6,3), `ndolar` FLOAT, `cestado` CHAR)
BEGIN
...
prec=nprecio,prod_uti1=nutil1,prod_uti2=nutil2,prod_uti3=nutil3,prod_cod1=ccoda,
prod_come=ncome,prod_comc=ncomc,prod_uact=nidus,prod_fact=localtime,prod_smax=nsmax,
prod_smin=nsmin,prod_tigv=tigv,prod_dola=ndolar,prod_acti=cestado  WHERE idart=ncoda;
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProActualizaProveedor`(`nid` INTEGER, `cruc` VARCHAR(11), `crazo` VARCHAR(100), `cdire` VARCHAR(100), `cciud` VARCHAR(100), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cemail` VARCHAR(45), `nidus` INTEGER, `ccelu` VARCHAR(15), `crefe` VARCHAR(2005), `crpm` VARCHAR(10))
BEGIN
update fe_prov set
...
/*!50003 CREATE PROCEDURE `ProActualizaRCompras`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitems` INTEGER, `npvta` FLOAT, `nidauto` INTEGER, `nexon` DECIMAL(12,2), `notros` DECIMAL(12,2))
BEGIN
declare idce integer;
select gene_idce into idce from fe_gene where idgene=1;
   update fe_rcom set tdoc=ctdoc,form=cform,ndoc=cndoc,fech=dfecha,fecr=dfechar,deta=cdetalle,valor=nv,igv=nigv,impo=nt,ndo2=cndo2,
   mone=cm,dolar=ndolar,vigv=ni,tcom=ctg,idprov=ccodp,tipom=cmvto,idusua1=nus,codt=nidcodt,rcom_exon=nexon,rcom_otro=notros where idauto=nidauto;
   call ProDesactivaLcajaE(nidauto);
   if idce>0 and cform='E' then
      Call ProIngresaDatosLcajaE1(dfecha,"",concat("Compra contado ",cndoc),idce,0,nt,cm,ndolar,nus,ccodp,nidauto);
   end if;
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProActualizaRvendedores`(`nauto` INTEGER, `nidrc` INTEGER, `nidcl` INTEGER, `cform` CHAR, `codv` INTEGER, `nidr` INTEGER)
BEGIN
...
/* Procedure structure for procedure `ProActualizaSerieProducto` */

/*!50003 DROP PROCEDURE IF EXISTS  `ProActualizaSerieProducto` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `ProActualizaSerieProducto`(`nidre` INTEGER, `cserie` VARCHAR(60))
Begin
update fe_rseries set rser_seri=cserie where rser_idse=nidre;
End */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProAnulaTransacciones`(OUT `estado` VARCHAR(500), IN `ctdoc` VARCHAR(2), IN `cndoc` VARCHAR(12), IN `ctipo` CHAR, IN `nidauto` INTEGER, IN `nu` INTEGER, IN `sw` CHAR, `dfecha` DATE, IN `nu1` INTEGER)
BEGIN
declare nid integer;
...
/*!50003 CREATE PROCEDURE `ProAnulaTransacciones1`(OUT `estado` VARCHAR(500), `ctdoc` VARCHAR(2), `cndoc` VARCHAR(12), `ctipo` CHAR, `nidauto` INTEGER, `nu` INTEGER, `sw` CHAR, `dfecha` DATE, `nu1` INTEGER, `nimporte` decimal(8,2))
BEGIN
declare nid integer;
DECLARE EXIT HANDLER FOR SQLEXCEPTION,SQLWARNING,NOT FOUND
begin
...
if nidauto=0 then
   ...
   set @cn1:=cndoc;
   set @df:=dfecha;
   select @idclave:=idauto,@nimp:=impo from fe_rcom where tdoc=ctdoc and ndoc=cndoc and tipom =ctipo;
   set nid=@idclave;
  else
   set nid=nidauto;
   select @ct:=tdoc,@cn1:=ndoc,@df:=fech,@nimp:=impo from fe_rcom where idauto=nid;
end if;
if nid>0 then
   update fe_rcom set acti='I',idusua1=nu,rcom_idus=nu1 where idauto=nid;
   if ctipo='V' then
...
if sw='S' and ctipo='V' then
   call PROingresa_anulada1(@df,@cn1,@ct,nu,0,0);
end if;
set estado=null;
commit;
set estado:="Ok";
...
/*!50003 CREATE PROCEDURE `Proeditaclipro`(IN `crazo` VARCHAR(60), IN `cdire` VARCHAR(60), IN `cciud` VARCHAR(60), IN `cfono` VARCHAR(10), IN `cfax` VARCHAR(10), IN `nid` INTEGER, IN `opt` INTEGER, IN `cdni` VARCHAR(8))
BEGIN
if opt=0 then
...
/*!50003 CREATE PROCEDURE `ProIngresaAcaja`(IN `df` DATE, IN `cu` VARCHAR(50), IN `cd` VARCHAR(80), IN `impo` FLOAT, IN `cm` CHAR)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProIngresaAcreditos`(IN `cu` VARCHAR(50), IN `cndoc` VARCHAR(10), IN `cd` VARCHAR(80), IN `nimpo` FLOAT, IN `nacta` FLOAT, IN `nidclie` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProingresaAKardex`(IN `cu` VARCHAR(50), IN `cd` VARCHAR(80), IN `nidart` INTEGER, IN `ncant` FLOAT, IN `nprec` FLOAT, IN `nid` INTEGER, IN `cndoc` VARCHAR(10), IN `ctdoc` VARCHAR(2))
BEGIN
...
/*!50003 CREATE PROCEDURE `ProIngresaCopia`(`nidart` INTEGER, `cdes` VARCHAR(100), `cuni` VARCHAR(4), `ncant` DECIMAL(12,2), `nprec` DECIMAL(12,4), `cestado` CHAR, `nidcl` INTEGER, `ccliente` VARCHAR(100), `opt` INTEGER, `nidalma` INTEGER, `nidped` INTEGER)
begin
if opt=0 then
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaE1`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
lcaj_idus,lcaj_clpr,lcaj_idau)values
(dfecha,cndoc,cdeta,idcta,sdeudor,sacreedor,cmone,ndolar,nidus,nidcp,nidauto);
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEefectivo`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(120), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(12), `ctdoc` VARCHAR(2))
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaeEfectivo11`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` VARCHAR(12), `ctdoc` VARCHAR(2), `ncodt` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
lcaj_idus,lcaj_clpr,lcaj_idau,lcaj_form,lcaj_dcto,lcaj_tdoc,lcaj_codt)values
(dfecha,cndoc,cdeta,idcta,sdeudor,sacreedor,cmone,ndolar,nidus,nidcp,nidauto,cform,cdcto,ctdoc,ncodt);
end */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEfectivo11`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` VARCHAR(12), `ctdoc` VARCHAR(2), `ncodt` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
lcaj_idus,lcaj_clpr,lcaj_idau,lcaj_form,lcaj_dcto,lcaj_tdoc,lcaj_codt)values
(dfecha,cndoc,cdeta,idcta,sdeudor,sacreedor,cmone,ndolar,nidus,nidcp,nidauto,cform,cdcto,ctdoc,ncodt);
...
`nprecio` DECIMAL(12,2), `ncant` DECIMAL(10,2),cunidad varchar(15))
begin
   insert into fe_detallevta(detv_desc,detv_item,detv_ite1,detv_ite2,detv_idau,detv_prec,detv_cant,detv_unid)
   values(cdesc,nitem,nitem1,nitem2,nidauto,nprecio,ncant,cunidad);
end */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProIngresaRBajas`(`dfecha` DATE, `ctdoc` VARCHAR(2), `cserie` VARCHAR(4), `cnumero` VARCHAR(8), `cmotivo` VARCHAR(50), `cxml` LONGBLOB, `cticket` VARCHAR(30), `carchivo` VARCHAR(70), `chash` VARCHAR(30), `nidauto` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProIngresaResumenBoletas`(`dfecha` DATE, `ctdoc` VARCHAR(2), `cserie` VARCHAR(4), `cdesde` VARCHAR(12), `chasta` VARCHAR(12), `nimpo` DECIMAL(12,2), `nvalor` DECIMAL(12,2), `nexon` DECIMAL(12,2), `ninafecta` DECIMAL(12,2), `nigv` DECIMAL(12,2), `ngrati` DECIMAL(12,2), `cxml` LONGBLOB, `chash` VARCHAR(30), `carchivo` VARCHAR(70), `cticket` VARCHAR(30))
BEGIN
...
/*!50003 CREATE PROCEDURE `ProIngresaRvendedores`(`nauto` INTEGER, `nidrc` INTEGER, `nidcl` INTEGER, `cform` CHAR, `codv` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `Proingresa_anulada1`(`dfecha` DATETIME, `cndoc` VARCHAR(12), `ctdoc` VARCHAR(2), `nidus` INTEGER, `nidcon` INTEGER, `nimporte` FLOAT)
begin
 select @nc:=idclie from fe_clie where nruc='***********' limit 1;
 insert into fe_rcom(idcliente,fech,fecr,ndoc,tdoc,tipom,deta,ndo2,tcom,form,mone,exon,fusua,idusua,impo)
 values(@nc,dfecha,dfecha,cndoc,ctdoc,'V','','','K','E','S','N',localtime,nidus,0);
 SELECT @na:=LAST_INSERT_ID() FROM fe_rcom group by LAST_INSERT_ID();
...
BEGIN
SELECT nomb,idalma,dire,ciud,sucuidserie,ubigeo FROM fe_sucu ORDER BY idalma;
END */$$
DELIMITER ;
...
round(if(tmon='S',(a.prec*vigv)+b.prec,(a.prec*vigv*nd)+b.prec),2) as costo,
uno,dos,tre,cua,cero,c.idgrupo,c.dcat,prod_dola,
round(if(tmon='S',(a.prec*vigv),(a.prec*vigv*nd)),2) as costosf,b.prec as flete,idart,
ifnull(d.cost_cost,0) as costor,ifnull(d.cost_prec,0) as precr,ifnull(d.cost_mone,'')  as moner,
cast(ifnull(d.cost_idco,0) as unsigned) as cost_idco,ifnull(d.cost_flet,0)  as fleter,ifnull(d.cost_dola,0) as dolar,
peso,a.prec,tipro,idmar,a.idcat,cost,tmon,a.idflete,prod_uti1,prod_uti2,prod_uti3,prod_idus,
...
/*!50003 CREATE PROCEDURE `ProMuestraProductos1`(`abuscar` VARCHAR(80), `nd` FLOAT, `opt` INTEGER, `nid` VARCHAR(20))
BEGIN
DECLARE cbuscar VARCHAR(80);
case
when opt=1 THEN
    ...
    IFNULL(ROUND(IF(tmon='S',((a.prec*prod_tigv)+b.prec)*prod_uti1,((a.prec*prod_tigv*nd)+b.prec)*prod_uti1),2),0) AS pre1,
    IFNULL(ROUND(IF(tmon='S',((a.prec*prod_tigv)+b.prec)*prod_uti2,((a.prec*prod_tigv*nd)+b.prec)*prod_uti2),2),0) AS pre2,
    IFNULL(ROUND(IF(tmon='S',((a.prec*prod_tigv)+b.prec)*prod_uti3,((a.prec*prod_tigv*nd)+b.prec)*prod_uti3),2),0) AS pre3,
    ROUND(IF(tmon='S',(a.prec*prod_tigv)+b.prec,(a.prec*prod_tigv*nd)+b.prec),2) AS costo,c.idgrupo,c.dcat,prod_dola,prod_cod1,caracteris,
    ROUND(IF(tmon='S',(a.prec*prod_tigv),(a.prec*prod_tigv*nd)),2) AS costosf,b.prec AS flete,
    IFNULL(d.cost_cost,0) AS costor,IFNULL(d.cost_prec,0) AS precr,IFNULL(d.cost_mone,'')  AS moner,
    CAST(IFNULL(d.cost_idco,0) AS UNSIGNED) AS cost_idco,IFNULL(d.cost_flet,0)  AS fleter,IFNULL(d.cost_dola,0) AS dolar,
    peso,a.prec,tipro,idmar,a.idcat,cost,tmon,a.idflete,prod_uti1,prod_uti2,prod_uti3,
    prod_come,prod_comc,ulpc,prod_idus,prod_uact,prod_fact,fechc,prod_smax,prod_smin,IFNULL(o.razo,'') AS proveedor,
    IFNULL(yy.ndoc,'') AS ndoc,IFNULL(yy.fech,'') AS fech,ulfc,'n' AS modi,prod_codf,prod_tigv,
    u.nomb AS usuacreo,us.nomb AS usuamodifico
    FROM fe_art  AS a INNER JOIN fe_fletes AS b ON(b.idflete=a.idflete)
...
when opt=0 then
    ...
    LEFT JOIN fe_usua AS u ON u.idusua=a.prod_idus
    LEFT JOIN fe_usua AS us ON us.idusua=a.prod_uact
    WHERE CAST(idart AS CHAR) = cbuscar AND prod_acti<>'I' ORDER BY DESCRI;
WHEN opt=2 THEN
    SET cbuscar=CONCAT('%',TRIM(abuscar),+'%');
    SELECT idart,descri,unid,uno,dos,tre,cua,cero,
    IFNULL(ROUND(IF(tmon='S',((a.prec*prod_tigv)+b.prec)*prod_uti1,((a.prec*prod_tigv*nd)+b.prec)*prod_uti1),2),0) AS pre1,
...
/* Procedure structure for procedure `Vtas2` */

/*!50003 DROP PROCEDURE IF EXISTS  `Vtas2` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `Vtas2`()
BEGIN
DECLARE done INT DEFAULT 0;
declare nidauto integer;
declare cursor1 cursor for
select idauto from fe_rcom where left(ndoc,4) in("F002","B002") and idcliente>0 and acti='A';
DECLARE CONTINUE HANDLER FOR SQLSTATE '02000' SET done = 1;
open cursor1;
start transaction;
repeat
    fetch cursor1 into nidauto;
    update fe_kar set alma=2 where idauto=nidauto;
until done end repeat;
commit;
END */$$
DELIMITER ;
...
/*!50001 CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vguiascompras` AS select `fe_guiac`.`guic_idau` AS `guic_idau`,`fe_guiac`.`guic_tipo` AS `guic_tipo`,cast(ifnull(`fe_guiac`.`guic_idac`,0) as signed) AS `guic_idac` from `fe_guiac` where (`fe_guiac`.`guic_acti` = 'A') group by `fe_guiac`.`guic_idau`,`fe_guiac`.`guic_tipo`,`fe_guiac`.`guic_idac` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vmuestraventas` AS select `c`.`rcom_mens` AS `rcom_mens`,`c`.`idusua` AS `idusua`,`a`.`kar_comi` AS `kar_comi`,`a`.`codv` AS `codv`,`a`.`idauto` AS `idauto`,`c`.`codt` AS `alma`,`a`.`kar_idco` AS `idcosto`,`a`.`idkar` AS `idkar`,`a`.`idart` AS `Coda`,`a`.`cant` AS `cant`,`a`.`prec` AS `prec`,`c`.`valor` AS `valor`,`c`.`igv` AS `igv`,`c`.`impo` AS `impo`,`c`.`fech` AS `fech`,`c`.`fecr` AS `fecr`,`c`.`form` AS `form`,`c`.`deta` AS `deta`,`c`.`exon` AS `exon`,`c`.`ndo2` AS `ndo2`,`c`.`rcom_entr` AS `rcom_entr`,`c`.`idcliente` AS `idclie`,`d`.`razo` AS `razo`,`d`.`nruc` AS `nruc`,`d`.`dire` AS `dire`,`d`.`ciud` AS `ciud`,`d`.`ndni` AS `ndni`,`a`.`tipo` AS `tipo`,`c`.`rcom_exon` AS `rcom_exon`,`c`.`tdoc` AS `tdoc`,`c`.`ndoc` AS `ndoc`,`c`.`dolar` AS `dolar`,`c`.`mone` AS `mone`,`b`.`descri` AS `descri`,ifnull(`x`.`idcaja`,0) AS `idcaja`,`b`.`unid` AS `unid`,`b`.`premay` AS `pre1`,`b`.`peso` AS `peso`,`b`.`premen` AS `pre2`,ifnull(`z`.`vend_idrv`,0) AS `nidrv`,`c`.`vigv` AS `vigv`,`a`.`dsnc` AS `dsnc`,`a`.`dsnd` AS `dsnd`,`a`.`gast` AS `gast`,`c`.`idcliente` AS `idcliente`,`c`.`codt` AS `codt`,`b`.`pre3` AS `pre3`,`b`.`cost` AS `costo`,`b`.`uno` AS `uno`,`b`.`dos` AS `dos`,(`b`.`uno` + `b`.`dos`) AS `TAlma`,`c`.`fusua` AS `fusua`,`p`.`nomv` AS `Vendedor`,`q`.`nomb` AS `Usuario`,`c`.`rcom_tipo` AS `rcom_tipo` from (((((((`fe_art` `b` join `fe_kar` `a` on((`a`.`idart` = `b`.`idart`))) join `fe_rcom` `c` on((`a`.`idauto` = `c`.`idauto`))) left join `fe_caja` `x` on((`x`.`idauto` = `c`.`idauto`))) join `fe_clie` `d` on((`c`.`idcliente` = `d`.`idclie`))) join `fe_vend` `p` on((`p`.`idven` = `a`.`codv`))) join `fe_usua` `q` on((`q`.`idusua` = `c`.`idusua`))) left join `fe_rvendedor` `z` on((`z`.`vend_idau` = `c`.`idauto`))) where ((`c`.`acti` <> 'I') and (`a`.`acti` <> 'I')) */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vsaldos` AS select `a`.`pdte_idar` AS `pdte_idar`,`a`.`pdte_cant` AS `Pedido`,0 AS `Entregado`,`a`.`pdte_idau` AS `pdte_idau`,`a`.`pdte_idus` AS `pdte_idus`,`a`.`pdte_idin` AS `idin` from `fe_ipdtes` `a` where (`a`.`pdte_Acti` <> 'I') */;
