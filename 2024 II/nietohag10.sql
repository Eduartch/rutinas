...
MySQL - 8.0.37 : Database - syscom_bdnietohag
*********************************************************************
*/
...
dfevto DATETIME,nacta FLOAT,cndoc VARCHAR(12),cesta CHAR,cmone CHAR,cb1 VARCHAR(150),ctipo CHAR,
nidrc INTEGER,idusua INTEGER,nctrl INTEGER,cnrou VARCHAR(25),cpc VARCHAR(45),ndolar FLOAT,nidanti INTEGER,nidantid INTEGER) RETURNS int
BEGIN
DECLARE nid INTEGER;
SET nid=0;
...
cmon CHAR,dfecha DATE,nimpoo DECIMAL(12,2),nidus INTEGER,nidtda INTEGER,cpc VARCHAR(45),nidcta INTEGER) RETURNS int
BEGIN
DECLARE id INTEGER DEFAULT 0;
...
/*!50003 CREATE PROCEDURE `ProMuestraProductos1`(abuscar VARCHAR(80),nd decimal(6,4),opt INTEGER,nid VARCHAR(20))
BEGIN
DECLARE cbuscar VARCHAR(80);
case 
when opt=0 then
