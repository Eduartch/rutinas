...
MySQL - 8.0.39 : Database - syscom_bdiaisac
*********************************************************************
*/
...
prod_smin=nsmin,prod_dola=ndolar,prod_coda=ccoda,prod_refe=crefe,prod_flet=vflete  WHERE idart=ncoda;
END */$$
DELIMITER ;
