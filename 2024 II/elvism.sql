...
MySQL - 8.0.42 : Database - syscom_bdelvism
*********************************************************************
*/
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaE`(`dfecha` DATETIME, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidtda` INTEGER) RETURNS int
BEGIN
DECLARE id INTEGER;
...
/*!50003 CREATE FUNCTION `FuningresaDCotizacion`(`ncoda` VARCHAR(15), `ncant` FLOAT, `nprec` FLOAT, `nidauto` INTEGER) RETURNS int
BEGIN
declare id integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaKardex1`(`nid` INTEGER, `cc` VARCHAR(15), `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `tmvto` CHAR, `ccodv` INTEGER, `calma` INTEGER, `nidcosto1` INTEGER, `vcom` FLOAT, `codi` INTEGER) RETURNS int
BEGIN
declare nidk integer default 0;
if ct='C' then
...
/*!50003 CREATE FUNCTION `FUNINGRESANOTASCREDITOventas`(`nid0` INTEGER, `nid1` INTEGER,nipd integer) RETURNS int
BEGIN
declare id integer default 0;
...
/*!50003 CREATE PROCEDURE `ProActualizaKardex1`(`nid` INTEGER, `cc` VARCHAR(15), `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `tmvto` CHAR, `ccodv` INTEGER, `calma` INTEGER, `nidcosto1` INTEGER, `nidkar` INTEGER, `op` INTEGER, `xcom` FLOAT)
BEGIN
IF op=0 THEN
...
/*!50003 CREATE PROCEDURE `PRODSTOCKS`(`nidart` VARCHAR(25))
BEGIN
...
BEGIN
SELECT nomb,idalma,dire,ciud,sucuidserie,sucu_idus FROM fe_sucu where idalma in(1,2,5)  ORDER BY codigoestab ;
END */$$
DELIMITER ;
...
open cursor1;
start transaction;
UPDATE fe_art SET uno=0,dos=0,tre=0,cua=0,cin=0;
repeat
    fetch cursor1 into ccoda,tcompras,tventas,calma;
