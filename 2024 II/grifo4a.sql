...
MySQL - 8.0.39 : Database - syscom_bdgcuatroa
*********************************************************************
*/
...
INSERT INTO fe_contometro(cont_idar,cont_inic,cont_lado,cont_esta,cont_fech,cont_fope,cont_idus,cont_refe,cont_inim,cont_tpro,cont_ila)
...
BEGIN
INSERT INTO fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
lcaj_idus,lcaj_clpr,lcaj_idau,lcaj_form,lcaj_dcto,lcaj_tdoc,lcaj_codt,lcaj_idtu,lcaj_idle)VALUES
(dfecha,cndoc,cdeta,idcta,sdeudor,sacreedor,cmone,ndolar,nidus,nidcp,nidauto,cform,cdcto,ctdoc,ncodt,nturno,nidlectura);
END */$$
DELIMITER ;
...
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,1 AS codigo  FROM venta WHERE pump=1 AND idgrade=3 AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,1 AS codigo FROM venta WHERE pump=2 AND idgrade=3  AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,5 AS codigo  FROM venta WHERE pump=1 AND idgrade=1 AND nozzle=1 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
...
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,67 AS codigo  FROM venta WHERE pump=1 AND idgrade=2 AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,67 AS codigo FROM venta WHERE pump=2 AND idgrade=2  AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,1 AS codigo FROM venta WHERE pump=1 AND idgrade=3 AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
...
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,1 AS codigo  FROM venta WHERE pump=3 AND idgrade=3 AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,1 AS codigo FROM venta WHERE pump=4 AND idgrade=3  AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,67 AS codigo  FROM venta WHERE pump=4 AND idgrade=2 AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,67 AS codigo FROM venta WHERE pump=3 AND idgrade=3  AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
...
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,66 AS codigo  FROM venta WHERE pump=5 AND idgrade=4 AND nozzle=1 ORDER BY fecreg_inicio DESC LIMIT 1)
UNION
(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,66 AS codigo  FROM venta WHERE pump=6 AND idgrade=4 AND nozzle=1 ORDER BY fecreg_inicio DESC LIMIT 1);
END */$$
DELIMITER ;
...
CASE
  WHEN nisla=1 THEN
       (SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(5 as unsigned) AS codigo  FROM venta WHERE pump=1 AND idgrade=3 AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(5 as unsigned)AS codigo FROM venta WHERE pump=2 AND idgrade=3  AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(5 as unsigned) AS codigo  FROM venta WHERE pump=1 AND idgrade=1 AND nozzle=1 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(2  as unsigned) AS codigo FROM venta WHERE pump=2 AND idgrade=1 AND nozzle=1 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(67 as unsigned) AS codigo  FROM venta WHERE pump=1 AND idgrade=2 AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(67 as unsigned) AS codigo FROM venta WHERE pump=2 AND idgrade=2  AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(1 as unsigned) AS codigo FROM venta WHERE pump=1 AND idgrade=3 AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,cast(1 as unsigned) AS codigo FROM venta WHERE pump=2 AND idgrade=3  AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1);
   WHEN nisla=2 THEN
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,1 AS codigo  FROM venta WHERE pump=3 AND idgrade=3 AND nozzle=4 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	...
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,67 AS codigo  FROM venta WHERE pump=3 AND idgrade=2 AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
	(SELECT idgrade,gradename AS producto,pump AS surtidor,nozzle AS lado,totalvolume AS lectura,totalamount AS monto,
	fecreg_inicio AS inicio,fecreg_fin AS fin,price AS precio,67 AS codigo FROM venta WHERE pump=4 AND idgrade=2  AND nozzle=3 ORDER BY fecreg_inicio DESC LIMIT 1)
	UNION
...
BEGIN
SELECT cont_surt,descri,cont_lado,cont_inic,cont_inim,cont_fech,nomb,cont_fope,cont_isla,cont_tpro
FROM fe_contometro f inner join fe_art a on a.idart=f.cont_idar inner join fe_usua u on u.idusua=f.cont_idus
where cont_esta='A' and cont_acti='A'  order by cont_surt,cont_lado,descri;
END */$$
DELIMITER ;
...
round(if(tmon='S',(a.prec*vigv),(a.prec*vigv*nd)),2) as costosf,b.prec as flete,coda1,
ifnull(d.cost_cost,0) as costor,ifnull(d.cost_prec,0) as precr,ifnull(d.cost_mone,'')  as moner,
cast(ifnull(d.cost_idco,0) as unsigned) as cost_idco,ifnull(d.cost_flet,0)  as fleter,ifnull(d.cost_dola,0) as dolar,
peso,a.prec,tipro,idmar,a.idcat,cost,tmon,a.idflete,prod_uti1,prod_uti2,prod_uti3,prod_idus,
...
when opt='O' then
   SET cbuscar=CONCAT('%',TRIM(abuscar),+'%');
   SELECT idart,descri,unid,uno,dos,tre,cua,premay as pre1,
   ifnull(round(if(tmon='S',((a.prec*vv.igv)+b.prec)*prod_uti2,((a.prec*vv.igv*if(prod_dola>nd,prod_dola,nd))+b.prec)*prod_uti2),2),0) as pre2,
   ifnull(round(if(tmon='S',((a.prec*vv.igv)+b.prec)*prod_uti3,((a.prec*vv.igv*if(prod_dola>nd,prod_dola,nd))+b.prec)*prod_uti3),2),0) as pre3,
   round(if(tmon='S',(a.prec*vv.igv)+b.prec,(a.prec*vv.igv*nd)+b.prec),4) as costo,c.idgrupo,c.dcat,prod_dola,
   round(if(tmon='S',(a.prec*vv.igv),(a.prec*vv.igv*nd)),2) as costosf,b.prec as flete,
...
/*!50003 CREATE PROCEDURE `ProObtieneValoresContometro`(nidart integer)
BEGIN
select cont_surt,descri,cont_lado,cont_inic,cont_inim,cont_fech,nomb,cont_fope,cont_refe,cont_idcon,cont_idar,cont_idus from
fe_contometro c inner join fe_art a on a.idart=c.cont_idar inner join fe_usua u on u.idusua=c.cont_idus
where  cont_esta='A' and cont_acti='A' and cont_idar=nidart;
END */$$
DELIMITER ;
