...
MySQL - 8.0.44 : Database - syscom_bdbatcars
*********************************************************************
*/
...
/*!50003 CREATE FUNCTION `FunCreaCLiente`(`cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(50), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cdni` VARCHAR(11), `ctipo` CHAR, `cemail` VARCHAR(45), `nidven` INTEGER, `nidus` INTEGER, `cpc` VARCHAR(45), `ccelu` VARCHAR(15), `crefe` VARCHAR(255), `linea` FLOAT, `crpm` VARCHAR(10), `nidz` INTEGER) RETURNS int
BEGIN
...
/*!50003 CREATE FUNCTION `FunCreaCLientecd`(`cruc` VARCHAR(11), `crazo` VARCHAR(100), `cdire` VARCHAR(100), `cciud` VARCHAR(100), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cdni` VARCHAR(11), `ctipo` CHAR, `cemail` VARCHAR(45), `nidven` INTEGER, `nidus` INTEGER, `cpc` VARCHAR(45), `ccelu` VARCHAR(15), `crefe` VARCHAR(255), `linea` FLOAT, `crpm` VARCHAR(10), `nidz` INTEGER, `nidop` INTEGER, `cdist` VARCHAR(100)) RETURNS int
BEGIN
declare nid integer default 0;
INSERT INTO fe_clie(nruc,razo,dire,ciud,fono,fax,ndni,clie_tipo,clie_corr,clie_codv,clie_idus,idpcclie,
...
/*!50003 CREATE FUNCTION `FunCreaCliPro`(`cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(60), `cfono` VARCHAR(10), `cfax` VARCHAR(10), `opt` INTEGER, `cdni` VARCHAR(10)) RETURNS int
BEGIN
declare nid integer;
set nid=0;
if opt=0 then
...
/*!50003 CREATE FUNCTION `FuncreaConceptosCaja`(`cdescri` VARCHAR(50), `ctipo` CHAR, `ctdoc` VARCHAR(3), `cusua` VARCHAR(45), `cidpc` VARCHAR(50), `norden` INTEGER, `idcon1` INTEGER) RETURNS int
begin
...
/*!50003 CREATE FUNCTION `FunCreaEmpleado`(`crazo` VARCHAR(80), `cfono` VARCHAR(20), `nsueldo` FLOAT, `nidus` INTEGER, `cidpc` VARCHAR(45), `crefe` VARCHAR(80)) RETURNS int
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunCreaFletes`(`cdescri` VARCHAR(45), `nprecio` FLOAT, `nidus` INTEGER, `cidpc` VARCHAR(45)) RETURNS int
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaLinea`(`cdescri` VARCHAR(45), `nidus` INTEGER, `cidpc` VARCHAR(45), `nutil1` FLOAT, `nutil2` FLOAT, `nidgrupo` INTEGER) RETURNS int
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaMarcas`(`cdescri` VARCHAR(45), `nidus` INTEGER, `cidpc` VARCHAR(45)) RETURNS int
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaPlanCuentas`(`cn` VARCHAR(8), `cdes` VARCHAR(60), `cdd` VARCHAR(8), `cdh` VARCHAR(8), `cuenta` VARCHAR(12), `cope` CHAR) RETURNS int
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FuncreaProductos`(`ccoda` VARCHAR(15), `cdesc` VARCHAR(60), `cunid` VARCHAR(4), 
`nprec` FLOAT, `ncosto` FLOAT, `np1` FLOAT, `np2` FLOAT, `np3` FLOAT, `npeso` FLOAT, `ccat` INTEGER, `cmar` INTEGER, 
`ctipro` CHAR, `nflete` INTEGER, `cm` CHAR, `cidpc` VARCHAR(45), `ncome` FLOAT, `ncomc` FLOAT, `nutil1` FLOAT, `nutil2` FLOAT,
 `nutil3` FLOAT, `nidusua` INTEGER, `nsmin` FLOAT, `nsmax` FLOAT, `nidcosto` INTEGER,
  `ndolar` FLOAT,ccodb VARCHAR(20)) RETURNS varchar(15) CHARSET latin1
BEGIN
...
prod_comc,prod_uti1,prod_uti2,prod_uti3,prod_idus,prod_smin,prod_smax,prod_idco,prod_dola,prod_cod1)
VALUES (ccoda,cdesc,cunid,nprec,ncosto,np1,np2,np3,npeso,ccat,cmar,ctipro,nflete,cm,LOCALTIME,
cidpc,ncome,ncomc,nutil1,nutil2,nutil3,nidusua,nsmin,nsmax,nidcosto,ndolar,ccodb);
RETURN ccoda;
END */$$
DELIMITER ;
...
/*!50003 CREATE FUNCTION `FuncreaProductos1`(`cdesc` VARCHAR(60), `cunid` VARCHAR(4), `nprec` FLOAT, `ncosto` FLOAT, `np1` FLOAT, `np2` FLOAT, `np3` FLOAT, `npeso` FLOAT, `ccat` INTEGER, `cmar` INTEGER, `ctipro` CHAR, `nflete` INTEGER, `cm` CHAR, `cidpc` VARCHAR(45), `nidgrupo` INTEGER, `ncome` FLOAT, `ncomc` FLOAT, `nutil1` FLOAT, `nutil2` FLOAT, `nutil3` FLOAT, `nidusua` INTEGER, `nsmin` FLOAT, `nsmax` FLOAT, `ccoda1` VARCHAR(6), `ndolar` FLOAT) RETURNS int
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunCreaProveedor`(`cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(60), `cfono` VARCHAR(10), `cfax` VARCHAR(10), `crpm` VARCHAR(10), `correo` VARCHAR(45), `crefe` VARCHAR(200), `ccelu` VARCHAR(10), `nidus` INTEGER, `cpc` VARCHAR(45)) RETURNS int
BEGIN
declare nid integer default 0;
...
declare sw integer default 0;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET sw=0;
select idauto into sw from fe_rcom where ndoc=cdcto and tdoc=ctdoc and tcom='T' and acti<>'I' limit 1;
return sw;
END */$$
DELIMITER ;
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraPedido`(`dfech` DATE, `nidclie` INTEGER, `cndoc` VARCHAR(10), `ctdoc` VARCHAR(2), `nimpo` FLOAT, `cform` CHAR, `nidus` INTEGER, `cidpcped` VARCHAR(45), `nidven` INTEGER, `nidtienda` INTEGER, `ctipop` CHAR) RETURNS int
BEGIN
declare nid integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaCabeceraV1`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(10), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` FLOAT, `nigv` FLOAT, `nt` FLOAT, `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitem` INTEGER, `npvta` FLOAT, `nidin` INTEGER) RETURNS int
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaCaja`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(10), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `cajas` CHAR, `nidcredito` INT, `ide` INTEGER) RETURNS int
BEGIN
declare nid integer;
set nid=0;
if cajas='A' then
...
/*!50003 CREATE FUNCTION `FunIngresaCajaBancos`(`idb` INTEGER, `dfecha` DATE, `nop` VARCHAR(20), `idmp` INTEGER, `cdeta` VARCHAR(120), `idpr` INTEGER, `idcl` INTEGER, `cndoc` VARCHAR(20), `idcta` INTEGER, `debe` DECIMAL(12,2), `haber` DECIMAL(12,2), `norden` INTEGER, `nidclpr` INTEGER) RETURNS int
BEGIN
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaCostos`(`ncosto` FLOAT, `nidauto` INTEGER, `nidart` VARCHAR(15), `nflete` FLOAT, `nprec` FLOAT, `cmone` CHAR, `ndola` FLOAT, `dfecha` DATE) RETURNS int
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunIngresaCreditos`(`nauto` INTEGER, `nidcl` INTEGER, `cndoc` VARCHAR(10), `cest` CHAR, `cmon` CHAR, `crefe` VARCHAR(120), `dfecha` DATE, `dfevto` DATE, `ctipo` CHAR, `cdocp` VARCHAR(10), `ndolar` FLOAT, `csitua` VARCHAR(2), `nimpo` FLOAT, `ni` FLOAT, `idven` INTEGER, `nimpoo` FLOAT, `cusua` INTEGER, `nidaval` INTEGER, `ndscto` FLOAT, `cpc` VARCHAR(50), `nidcodt` INTEGER) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaE`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidtda` INTEGER) RETURNS int
begin
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaE1`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER) RETURNS int
begin
declare id integer;
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaECreditos`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15), `nidtda` INTEGER) RETURNS int
begin
declare nid integer;
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaEDeudas`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15), `nidtda` INTEGER) RETURNS int
begin
declare nid integer;
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaEDeudasInteres`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15), `nidcaja` INTEGER, `nidtda` INTEGER) RETURNS int
begin
declare nid integer;
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLcajaEe`(`dfecha` DATETIME, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER) RETURNS int
begin
declare id integer;
if sdeudor>0 then
...
/*!50003 CREATE FUNCTION `FunIngresaDatosLibroDiario`(`dfech` DATETIME, `ndebe` DECIMAL(12,2), `nhaber` DECIMAL(12,2), `cglosa` VARCHAR(120), `ct` CHAR(1), `cnume` VARCHAR(10), `nidcta` INTEGER, `ccond` CHAR, `nit` INTEGER, `ncomp` VARCHAR(15), `nidcl` INTEGER, `nidpr` INTEGER, `cmone` CHAR) RETURNS int
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaDCreditos`(`dfecha` DATETIME, `dfevto` DATETIME, `nimpo` FLOAT, `cndoc` VARCHAR(12), `cest` CHAR, `cmon` CHAR, `crefe` VARCHAR(120), `ctipo` CHAR, `id1` INTEGER, `nidus` INTEGER) RETURNS int
BEGIN
declare id integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaDeudas`(`nidrd` INTEGER, `cndoc` VARCHAR(12), `cest` CHAR, `dfecha` DATE, `dfevto` DATE, `ctipo` CHAR, `ndolar` FLOAT, `nimpo` FLOAT, `cusua` INTEGER, `cpc` VARCHAR(50), `nidcodt` INTEGER, `cnrou` VARCHAR(15), `cdeta` VARCHAR(80), `csitua` VARCHAR(2)) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaDkardex`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `ccodv` INTEGER, `ct1` CHAR, `nidtda` INTEGER) RETURNS int
BEGIN
...
/*!50003 CREATE FUNCTION `FuningresaDocumentoElectronico`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `cdetalle` VARCHAR(220), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` DECIMAL(6,4), `ni` DECIMAL(6,4), `ctg` CHAR, `ccodp` INTEGER, 
`cgarantia` VARCHAR(50), `nus` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nvend` INTEGER, `idtr` DECIMAL(10,2), `nexon` DECIMAL(12,2), `ndscto` DECIMAL(12,2)) RETURNS int
BEGIN
DECLARE nid INTEGER;
SET nid=0;
   INSERT INTO fe_rcom(tdoc,form,ndoc,fech,fecr,deta,valor,igv,impo,ndo2,mone,dolar,vigv,tcom,idcliente,
   tipom,fusua,idusua,codt,pimpo,rcom_exon,rcom_dsct,rcom_vend,rcom_nitem)
   VALUES (ctdoc,cform,cndoc,dfecha,dfecha,cdetalle,nv,nigv,nt,cndo2,cm,ndolar,ni,ctg,ccodp,'V',LOCALTIME,nus,nidcodt,
   idtr,nexon,ndscto,nvend,cgarantia);
   SELECT LAST_INSERT_ID() INTO nid FROM fe_rcom GROUP BY LAST_INSERT_ID();
   IF n1>0 AND n2>0 AND n3>0 THEN
      CALL IngresaCuentasV(nv,nigv,nt,n1,n2,n3,"H","H","D",nid);
END IF;
...
/*!50003 CREATE FUNCTION `FunIngresaDPedidos`(`ncoda` VARCHAR(20), `ncant` FLOAT, `nprec` FLOAT, `nidauto` INTEGER) RETURNS int
BEGIN
declare id integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaKardex`(`nid` INTEGER, `cc` VARCHAR(15), `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `ct1` CHAR, `cdeta` VARCHAR(50), `nidtda` INTEGER, `nidtda1` INTEGER, `na1` INTEGER) RETURNS int
BEGIN
declare nidk integer default 0;
...
/*!50003 CREATE FUNCTION `FunIngresaKardex1`(`nid` INTEGER, `cc` VARCHAR(15), `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `tmvto` CHAR, `ccodv` INTEGER, `calma` INTEGER, 
`nidcosto1` DECIMAL(10,4), `vcom` FLOAT, `codi` INTEGER) RETURNS int
BEGIN
DECLARE nidk INTEGER DEFAULT 0;
IF ct='C' THEN
 ...
 ELSE
  INSERT INTO fe_kar(idauto,idart,tipo,prec,cant,ttip,incl,alma,kar_cost,codv,kar_alma1,kar_comi,kar_codi)
...
/*!50003 CREATE FUNCTION `FunIngresaKardexCambios`(`nid` INTEGER, `cc` INTEGER, `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cin` CHAR, `ccodv` INTEGER, `ctt` CHAR, `nidtda` INTEGER, `nidcosto` INTEGER) RETURNS int
BEGIN
declare nidk integer default 0;
...
/*!50003 CREATE FUNCTION `FUNINGRESANOTASCREDITOventas1`(`nid0` INTEGER, `nid1` INTEGER, `nidpagos` INTEGER,nimpo decimal(10,2)) RETURNS int
BEGIN
DECLARE id INTEGER DEFAULT 0;
...
/*!50003 CREATE FUNCTION `FunIngresaOrdenCompra`(`dfecha` DATE, `nidpr` INTEGER, `cmone` CHAR, `cndoc` VARCHAR(10), `ctigv` CHAR, `cobse` VARCHAR(200), `caten` VARCHAR(80), `cdeta` VARCHAR(200), `cidpc` VARCHAR(45), `nidus` INTEGER, `cdespacho` VARCHAR(60), `cforma` VARCHAR(60), `nv` FLOAT, `nigv` FLOAT, `nimpo` FLOAT) RETURNS int
BEGIN
declare nid integer;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditos`(`cndoc` VARCHAR(12), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosCreditosCb`(`cndoc` VARCHAR(10), `nacta` FLOAT, `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `dfech` DATE, `dfevto` DATE, `ctipo` CHAR, `nctrl` INTEGER, `cnrou` VARCHAR(40), `nidrc` FLOAT, `cpc` VARCHAR(45), `idusua` INTEGER, `idcb` INTEGER) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudas`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(12), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudasCb`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(12), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT, `idcb` INTEGER) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosDeudasConNotasCredito`(`dfech` DATETIME, `dfevto` DATETIME, `nacta` FLOAT, `cndoc` VARCHAR(12), `cesta` CHAR, `cmone` CHAR, `cb1` VARCHAR(100), `ctipo` CHAR, `nidrc` INTEGER, `idusua` INTEGER, `nctrl` INTEGER, `cnrou` VARCHAR(25), `cpc` VARCHAR(45), `ndolar` FLOAT, `nidn` INTEGER) RETURNS int
BEGIN
declare nid integer;
set nid=0;
...
/*!50003 CREATE FUNCTION `FunIngresaPagosEmpleados`(`nimpo` FLOAT, `nacta` FLOAT, `dfech` DATE, `ct` CHAR, `nidus` INTEGER, `nidcaja` INTEGER, `nidem` INTEGER, `cdeta` VARCHAR(100)) RETURNS int
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaRcreditos`(`nauto` INTEGER, `nid` INTEGER, `dfecha` DATETIME, `nidven` INTEGER, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `ninic` FLOAT, `cpc` VARCHAR(45)) RETURNS int
BEGIN
...
/*!50003 CREATE FUNCTION `FunIngresaRPUsados`(`dfecha` DATE, `cndoc` VARCHAR(10), `ctipo` CHAR, `nimpo` DECIMAL(12,2), `nidalma` INTEGER) RETURNS int
BEGIN
DECLARE nid INTEGER DEFAULT 0;
...
/*!50003 CREATE FUNCTION `FunRegistraCreditos`(`nauto` INTEGER, `nid` INTEGER, `cndoc` VARCHAR(12), `cest` CHAR, `cmon` CHAR, `crefe` VARCHAR(60), `dfecha` DATE, `dfevto` DATE, `ctipo` CHAR, `cdocp` VARCHAR(12), `nimpo` FLOAT, `ninic` FLOAT, `idven` INTEGER, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `cpc` VARCHAR(45)) RETURNS int
BEGIN
declare id integer default 0;
declare id1 integer default 0;
insert into fe_rcred(rcre_idcl,rcre_fech,rcre_idau,rcre_impc,rcre_idus,rcre_codt,rcre_idpc,rcre_inic,rcre_codv)
...
/*!50003 CREATE FUNCTION `FunRegistraDeudas`(`nauto` INTEGER, `nid` INTEGER, `cmon` CHAR, `dfecha` DATE, `nimpoo` FLOAT, `nidus` INTEGER, `nidtda` INTEGER, `cpc` VARCHAR(45)) RETURNS int
BEGIN
declare id integer default 0;
...
ON b.rcom_idau=a.karu_idau WHERE karu_idar=nidart  AND a.karu_Acti='A' AND b.rcom_acti='A' GROUP BY karu_idar ORDER BY rcom_fech DESC;
RETURN nid;
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ingresacaja`(IN `nauto` INTEGER, IN `cdcto` VARCHAR(10), IN `dfecha` DATE, IN `nimpo` FLOAT, IN `nimpo1` FLOAT, IN `cdeta` VARCHAR(120), IN `nidus` INTEGER, IN `cmon` CHAR, IN `idcreditos` INTEGER, IN `cf` CHAR, IN `nimporte1` FLOAT, IN `cmon1` CHAR, IN `ndola1` FLOAT, IN `cidpc` VARCHAR(50), IN `nidtda` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCaja`(`na` INTEGER, `dfecha` DATE, `nt1` FLOAT, `cmvtoc` CHAR, `cform` CHAR, `cm1` CHAR, `cndoc` VARCHAR(10), `nidcon` INTEGER, `cu` INTEGER, `cdetalle` VARCHAR(120), `cor` VARCHAR(2), `nimp1` FLOAT, `cm2` CHAR, `tcvta` FLOAT, `nidcodt` INTEGER, `nidcaja` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaCliente`(`nid` INTEGER, `cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(50), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cdni` VARCHAR(11), `ctipo` CHAR, `cemail` VARCHAR(45), `nidven` INTEGER, `nidus` INTEGER, `ccelu` VARCHAR(15), `crefe` VARCHAR(255), `linea` FLOAT, `crpm` VARCHAR(10), `nidz` INTEGER)
BEGIN
update fe_clie set
...
/*!50003 CREATE PROCEDURE `ProActualizaClienteCD`(`nid` INTEGER, `cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(50), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cdni` VARCHAR(11), `ctipo` CHAR, `cemail` VARCHAR(45), `nidven` INTEGER, `nidus` INTEGER, `ccelu` VARCHAR(15), `crefe` VARCHAR(255), `linea` FLOAT, `crpm` VARCHAR(10), `nidz` INTEGER, `nidpto` INTEGER, `cdist` VARCHAR(100))
BEGIN
update fe_clie set
nruc=cruc,razo=crazo,dire=cdire,ciud=cciud,fono=cfono,fax=cfax,ndni=cdni,clie_tipo=ctipo,clie_corr=cemail,
clie_codv=nidven,clie_actu=nidus,clie_feac=localtime,celu=ccelu,refe=crefe,clie_lcre=linea,clie_rpm=crpm,clie_idzo=nidz,
...
/*!50003 CREATE PROCEDURE `PROACTUALIZADATOSDIARIO`(`dfech` DATETIME, `ndebe` DECIMAL(12,2), `nhaber` DECIMAL(12,2), `cglosa` VARCHAR(120), `ct` CHAR(1), `cnume` VARCHAR(10), `nidcta` INTEGER, `idd` INTEGER, `opt` INTEGER, `ccond` CHAR, `nit` INTEGER, `ncomp` VARCHAR(15), `nidcl` INTEGER, `nidpr` INTEGER, `cmone` CHAR)
BEGIN
if opt=0 then
...
/*!50003 CREATE PROCEDURE `ProActualizaKardex1`(`nid` INTEGER, `cc` VARCHAR(15), `ct` CHAR, `npr` FLOAT, `nct` FLOAT, `cincl` CHAR, `tmvto` CHAR, `ccodv` INTEGER, `calma` INTEGER, 
`nidcosto1` DECIMAL(10,6), `nidkar` INTEGER, `op` INTEGER, `xcom` FLOAT)
BEGIN
IF op=0 THEN
...
/*!50003 CREATE PROCEDURE `ProActualizaPreciosProducto`(`cc` VARCHAR(15), `dfe` DATE, `npr` FLOAT, `cnd` INTEGER, `idp` INTEGER, `cmda` CHAR, `ni` FLOAT, `ndolar` FLOAT, `nidcosto` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaProductos`(`cdesc` VARCHAR(60), `cunid` VARCHAR(4), `ncosto` FLOAT, 
`np1` FLOAT, `np2` FLOAT, `np3` FLOAT, `npeso` FLOAT, `ccat` INTEGER, `cmar` INTEGER, `ctipro` CHAR, `nflete` INTEGER, `cm` CHAR,
 `nprecio` FLOAT, `nidgrupo` INTEGER, `nutil1` FLOAT, `nutil2` FLOAT, `nutil3` FLOAT, `ncome` FLOAT, `ncomc` FLOAT, 
 `nidus` INTEGER, `ncoda` VARCHAR(15), `nsmin` FLOAT, `nsmax` FLOAT, `nidcosto` INTEGER, `ndolar` FLOAT,ccodb VARCHAR(20))
BEGIN
...
prod_smin=nsmin,prod_idco=nidcosto,prod_dola=ndolar,prod_cod1=ccodb  WHERE idart=ncoda;
END */$$
DELIMITER ;

/* Procedure structure for procedure `ProActualizaProUsados` */

/*!50003 DROP PROCEDURE IF EXISTS  `ProActualizaProUsados` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `ProActualizaProUsados`(`cdesc` VARCHAR(150), `cdeta` VARCHAR(100), `opt` INTEGER, `nid` INTEGER)
BEGIN
IF opt=0 THEN
   UPDATE  fe_produsados SET pusa_acti='I'  WHERE pusa_idco=nid;
ELSE
   UPDATE  fe_produsados SET pusa_desc=cdesc,pusa_deta=cdeta WHERE pusa_idco=nid;
END IF;
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProActualizaProveedor`(`nid` INTEGER, `cruc` VARCHAR(11), `crazo` VARCHAR(60), `cdire` VARCHAR(60), `cciud` VARCHAR(50), `cfono` VARCHAR(15), `cfax` VARCHAR(15), `cemail` VARCHAR(45), `nidus` INTEGER, `ccelu` VARCHAR(15), `crefe` VARCHAR(2005), `crpm` VARCHAR(10))
BEGIN
update fe_prov set
...
/*!50003 CREATE PROCEDURE `ProActualizaRCompras1`(`ctdoc` VARCHAR(2), `cform` CHAR, `cndoc` VARCHAR(12), `dfecha` DATE, `dfechar` DATE, `cdetalle` VARCHAR(120), `nv` DECIMAL(12,2), `nigv` DECIMAL(12,2), `nt` DECIMAL(12,2), `cndo2` VARCHAR(10), `cm` CHAR, `ndolar` FLOAT, `ni` FLOAT, `ctg` CHAR, `ccodp` INTEGER, `cmvto` CHAR, `nus` INTEGER, `opt` INTEGER, `nidcodt` INTEGER, `n1` INTEGER, `n2` INTEGER, `n3` INTEGER, `nitems` INTEGER, `npvta` FLOAT, `nidauto` INTEGER, `nexon` DECIMAL(12,2), `notros` DECIMAL(12,2))
BEGIN
...
/*!50003 CREATE PROCEDURE `ProActualizaRPUsados`(`dfecha` DATE, `cndoc` VARCHAR(10), `ctipo` CHAR, `opt` INTEGER, `nimpo` DECIMAL(12,2), `nidalma` INTEGER, `nid` INTEGER)
BEGIN
IF opt=0 THEN
...
/*!50003 CREATE PROCEDURE `ProAnulaTransacciones`(OUT `estado` VARCHAR(500), `ctdoc` VARCHAR(2), `cndoc` VARCHAR(12), `ctipo` CHAR, `nidauto` INTEGER, `nu` INTEGER, `sw` CHAR, `dfecha` DATE, `nu1` INTEGER, `nidtda` INTEGER)
BEGIN
declare nid integer;
...
/* Procedure structure for procedure `ProCreaProUsados` */

/*!50003 DROP PROCEDURE IF EXISTS  `ProCreaProUsados` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `ProCreaProUsados`(`cdesc` VARCHAR(150), `cdeta` VARCHAR(100))
BEGIN
INSERT INTO fe_produsados(pusa_desc,pusa_deta)
VALUES(cdesc,cdeta);
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `PRODSTOCKS`(`nidart` varchar(20))
BEGIN
...
/*!50003 CREATE PROCEDURE `ProIngresaCajaI`(`dfecha` DATE, `cdeta` VARCHAR(150), `cesta` CHAR, `nimpo` DECIMAL(12,2), `ctipo` CHAR, `nidauto` INTEGER, `ncodt` INTEGER)
BEGIN
INSERT INTO fe_caja1(caja_fech,caja_deta,caja_esta,caja_impo,caja_tipo,caja_idau)
VALUES(dfecha,cdeta,cesta,nimpo,ctipo,nidauto);
END */$$
DELIMITER ;
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEefectivo`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(120), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15), `ctdoc` VARCHAR(2))
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEefectivo11`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` VARCHAR(12), `ctdoc` VARCHAR(2), `nidtda` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEefectivoCtarjeta`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(120), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15), `ctdoc` VARCHAR(2), `ctar` CHAR, `ttar` VARCHAR(50), `rtar` VARCHAR(50), `nidtda` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEefectivoTransferencia11`(`dfecha` DATE, `cndoc` VARCHAR(12), `cdeta` VARCHAR(120), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` CHAR(15), `ctdoc` VARCHAR(2), `nidtda` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
lcaj_idus,lcaj_clpr,lcaj_idau,lcaj_form,lcaj_fope,lcaj_dcto,lcaj_tdoc,lcaj_codt)values
...
/*!50003 CREATE PROCEDURE `ProIngresaDatosLcajaEfectivo11`(`dfecha` DATE, `cndoc` VARCHAR(10), `cdeta` VARCHAR(100), `idcta` INTEGER, `sdeudor` DECIMAL(12,2), `sacreedor` DECIMAL(12,2), `cmone` CHAR, `ndolar` DECIMAL(5,3), `nidus` INTEGER, `nidcp` INTEGER, `nidauto` INTEGER, `cform` CHAR, `cdcto` VARCHAR(12), `ctdoc` VARCHAR(2), `nidtda` INTEGER)
begin
insert into fe_lcaja(lcaj_fech,lcaj_ndoc,lcaj_deta,lcaj_idct,lcaj_deud,lcaj_acre,lcaj_mone,lcaj_dola,
...
/*!50003 CREATE PROCEDURE `ProIngresaRBajas`(`dfecha` DATE, `ctdoc` VARCHAR(2), `cserie` VARCHAR(4), `cnumero` VARCHAR(8), `cmotivo` VARCHAR(50), `cxml` LONGBLOB, `cticket` VARCHAR(15), `carchivo` VARCHAR(70), `chash` VARCHAR(30), `nidauto` INTEGER)
BEGIN
...
/*!50003 CREATE PROCEDURE `Proingresa_anulada1`(`dfecha` DATE, `cndoc` VARCHAR(12), `ctdoc` VARCHAR(2), `nidus` INTEGER, `nidcon` INTEGER, `nidtda` INTEGER)
begin
...
BEGIN
SELECT nomb,idalma,dire,ciud,sucuidserie,sucu_idus,ubigeo FROM fe_sucu  where idalma in(1,2,3) order by idalma;
END */$$
DELIMITER ;
...
left join fe_costos as d on(d.cost_idco=a.prod_idco), fe_gene as m
WHERE trim(idart)=trim(ncoda) and prod_acti<>'I' ORDER BY DESCRI;
END */$$
DELIMITER ;
...
WHEN opt=1 THEN
  ...
  IFNULL(ROUND(IF(tmon='S',((a.prec*v.igv)+b.prec)*prod_uti1,((a.prec*v.igv*nd)+b.prec)*prod_uti1),2),0) AS pre1,
  IFNULL(ROUND(IF(tmon='S',((a.prec*v.igv)+b.prec)*prod_uti2,((a.prec*v.igv*nd)+b.prec)*prod_uti2),2),0) AS pre2,
  IFNULL(ROUND(IF(tmon='S',((a.prec*v.igv)+b.prec)*prod_uti3,((a.prec*v.igv*nd)+b.prec)*prod_uti3),2),0) AS pre3,
  ROUND(IF(tmon='S',(a.prec*v.igv)+b.prec,(a.prec*v.igv*nd)+b.prec),2) AS costo,c.idgrupo,c.dcat,
  ROUND(IF(tmon='S',(a.prec*v.igv),(a.prec*v.igv*nd)),2) AS costosf,b.prec AS flete,a.ulfc,
  IFNULL(d.cost_cost,0) AS costor,IFNULL(d.cost_prec,0) AS precr,IFNULL(d.cost_mone,'')  AS moner,
  CAST(IFNULL(d.cost_idco,0) AS UNSIGNED) AS cost_idco,IFNULL(d.cost_flet,0)  AS fleter,IFNULL(d.cost_dola,0) AS dolar,
  peso,a.prec,tipro,idmar,a.idcat,cost,tmon,a.idflete,prod_uti1,prod_uti2,prod_uti3,prod_idus,
  prod_come,prod_comc,ulpc,prod_idus,prod_uact,prod_fact,fechc,prod_smax,prod_smin,IFNULL(o.razo,'') AS proveedor,
  IFNULL(yy.ndoc,'') AS ndoc,IFNULL(yy.fech,'') AS fech
  FROM fe_art  AS a 
  INNER JOIN fe_fletes AS b ON(b.idflete=a.idflete)
  INNER JOIN fe_cat AS c ON(c.idcat=a.idcat) 
...
/*!50003 CREATE PROCEDURE `ProMuestraProductosR`( `abuscar` VARCHAR(80), `nd` FLOAT, `opt` INTEGER, `sw` INTEGER)
BEGIN
DECLARE cbuscar VARCHAR(80);
SET cbuscar=CONCAT('%',TRIM(abuscar),+'%');
IF sw=1 THEN
   ...
   WHEN opt=1 THEN
	  ...
	  prod_come,prod_comc,ulpc,prod_idus,prod_uact,prod_fact,fechc,prod_smax,prod_smin,IFNULL(o.razo,'') AS proveedor,
	  IFNULL(yy.ndoc,'') AS ndoc,IFNULL(yy.fech,'') AS fech,prod_cod1
	  FROM fe_art  AS a 
	  INNER JOIN fe_fletes AS b ON(b.idflete=a.idflete)
	  INNER JOIN fe_cat AS c ON(c.idcat=a.idcat) 
	  LEFT JOIN fe_costos AS d ON(d.cost_idco=a.prod_idco)
 ...
 WHEN opt=0 THEN
   ...
   WHEN opt=2 THEN
	  ...
	  LEFT JOIN fe_rcom AS yy ON (yy.idauto=a.prod_idau) 
	  LEFT JOIN fe_prov AS o ON (o.idprov=yy.idprov),fe_gene AS v
	  WHERE prod_cod1 LIKE cbuscar  ORDER BY DESCRI;	  
     END CASE ;
ELSE
   CASE    
   WHEN  opt=1 THEN
...
/* Procedure structure for procedure `ProMuestraPUsados` */

/*!50003 DROP PROCEDURE IF EXISTS  `ProMuestraPUsados` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `ProMuestraPUsados`(`cb` VARCHAR(50))
BEGIN
DECLARE cb1 VARCHAR(50);
SET cb1=CONCAT("%",TRIM(cb),"%");
SELECT pusa_desc,pusa_deta,pusa_idco FROM fe_produsados WHERE pusa_desc LIKE cb1  AND pusa_acti='A' ORDER BY pusa_desc;
END */$$
DELIMITER ;
...
/*Table structure for table `vkbusada` */

DROP TABLE IF EXISTS `vkbusada`;

/*!50001 DROP VIEW IF EXISTS `vkbusada` */;
/*!50001 DROP TABLE IF EXISTS `vkbusada` */;

/*!50001 CREATE TABLE  `vkbusada`(
 `pusa_desc` varchar(150) ,
 `karu_cant` decimal(8,2) ,
 `karu_prec` decimal(8,2) ,
 `karu_idau` int unsigned ,
 `ndoc` varchar(10) ,
 `nomb` varchar(50) 
)*/;
...
/*View structure for view vkbusada */

/*!50001 DROP TABLE IF EXISTS `vkbusada` */;
/*!50001 DROP VIEW IF EXISTS `vkbusada` */;

/*!50001 CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vkbusada` AS select `p`.`pusa_desc` AS `pusa_desc`,`q`.`karu_cant` AS `karu_cant`,`q`.`karu_prec` AS `karu_prec`,`q`.`karu_idau` AS `karu_idau`,`r`.`rcom_ndoc` AS `ndoc`,`t`.`nomb` AS `nomb` from (((`fe_rcomu` `r` join `fe_karu` `q` on((`q`.`karu_idau` = `r`.`rcom_idau`))) join `fe_produsados` `p` on((`p`.`pusa_idco` = `q`.`karu_idar`))) join `fe_sucu` `t` on((`t`.`idalma` = `r`.`rcom_codt`))) where ((`q`.`karu_acti` = 'A') and (`r`.`rcom_acti` = 'A')) order by `r`.`rcom_idau` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `vpdtespago` AS select `a`.`ndoc` AS `ndoc`,`a`.`fech` AS `fech`,`a`.`dola` AS `dola`,`a`.`nrou` AS `nrou`,`a`.`banc` AS `banc`,`a`.`iddeu` AS `iddeu`,`s`.`fevto` AS `fevto`,`s`.`saldo` AS `saldo`,`s`.`rdeu_idpr` AS `Idpr`,`b`.`rdeu_impc` AS `ImporteC`,'C' AS `situa`,`b`.`rdeu_idau` AS `Idauto`,`s`.`ncontrol` AS `ncontrol`,`a`.`tipo` AS `tipo`,`a`.`banco` AS `banco`,ifnull(`c`.`ndoc`,'') AS `docd`,ifnull(`c`.`tdoc`,'') AS `tdoc`,`b`.`rdeu_mone` AS `Moneda`,`b`.`rdeu_codt` AS `Codt`,`b`.`rdeu_idrd` AS `Idrd`,`b`.`rdeu_idct` AS `rdeu_idct` from ((((`vpdtespagocompras` `s` join `fe_prov` `z` on((`z`.`idprov` = `s`.`rdeu_idpr`))) join `fe_deu` `a` on((`a`.`iddeu` = `s`.`ncontrol`))) join `fe_rdeu` `b` on((`b`.`rdeu_idrd` = `a`.`deud_idrd`))) left join `fe_rcom` `c` on((`c`.`idauto` = `b`.`rdeu_idau`))) order by `s`.`fevto` */;
