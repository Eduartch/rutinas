...
MySQL - 8.0.37 : Database - syscom_bdgrmotupe
*********************************************************************
*/
...
CASE
WHEN nisla=1 THEN
     SELECT  CONCAT(CAST(lect_idtu AS CHAR),'-',CAST(lect_idin AS CHAR)) AS lectura,lect_idin AS idin FROM fe_lecturas WHERE lect_fech=df AND lect_acti='A' AND lect_idco IN(1,2) and lect_esta='A' GROUP BY lect_idin,lect_idtu;
WHEN nisla=2 THEN
     SELECT  CONCAT(CAST(lect_idtu AS CHAR),'-',CAST(lect_idin AS CHAR)) AS lectura,lect_idin AS idin FROM fe_lecturas WHERE lect_fech=df AND lect_acti='A' AND lect_idco IN(3,4) and lect_esta='A' GROUP BY lect_idin,lect_idtu;
ELSE 
     SELECT  CONCAT(CAST(lect_idtu AS CHAR),'-',CAST(lect_idin AS CHAR)) AS lectura,lect_idin AS idin FROM fe_lecturas WHERE lect_fech=df AND lect_acti='A' AND lect_idco IN(5,6,7,8) and lect_esta='A' GROUP BY lect_idin,lect_idtu;
END CASE;     
END */$$
DELIMITER ;
