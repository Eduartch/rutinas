...
MySQL - 5.7.42 : Database - eduar_bdandinaj
*********************************************************************
*/
...
/*!50003 CREATE FUNCTION `FunIngresaKardex1`(nid integer,cc integer,ct char,npr decimal(13,6),
nct decimal(12,4),cincl char,tmvto char,ccodv integer,calma integer,nidcosto1 integer,vcom float) RETURNS int(11)
BEGIN
declare nidk integer default 0;
if ct='C' then
...
if opt=1 then
    ...
    prod_come,prod_comc,ulpc,prod_idus,prod_uact,prod_fact,fechc,prod_smax,prod_smin,ifnull(o.razo,'') as proveedor,
    ifnull(yy.ndoc,'') as ndoc,ifnull(yy.fech,'') as fech,ulfc,prod_ent1,prod_ent2,prod_icbper,g.idgrupo,g.desgrupo AS grupo
    FROM fe_art  as a 
    ...
    peso,a.prec,tipro,a.idmar,a.idcat,cost,tmon,a.idflete,prod_uti1,prod_uti2,prod_uti3,
    prod_come,prod_comc,ulpc,prod_idus,prod_uact,prod_fact,fechc,prod_smax,prod_smin,ifnull(o.razo,'') as proveedor,
    ifnull(yy.ndoc,'') as ndoc,ifnull(yy.fech,'') as fech,ulfc,prod_ent1,prod_ent2,prod_icbper,g.idgrupog.desgrupo AS grupo
    FROM fe_art  as a 
    inner join fe_fletes as b on(b.idflete=a.idflete)
    inner join fe_mar as m on m.idmar=a.idmar
    inner join fe_cat as c on(c.idcat=a.idcat) 
